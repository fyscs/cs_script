...
const boss_script = "boss3_script";//boss脚本实体targetname配置
const boss_template_targetname = "boss3_template";//boss模板实体targetname配置
const boss_position_targetname = "boss3_spawn_point";//boss生成位置targetname配置
const boss_phys_targetname = "Stage3_Boss";//boss物理碰撞实体的targetname配置
const boss_hpbar_targetname = "boss_hp_text_3";//boss血条实体的targetname配置
const boss_model_targetname = "Stage3_Boss_Model";//boss模型的targetname配置
...
class BossMain {
    ...
    boss_death() {
        ...
        if (!boss_death_animation_boolean) {
            ...
            Instance.EntFireAtName({ name: "boss3_end", input: "trigger" });
            return;
        }
        else {
            this.isActive = false;
