...
Instance.OnScriptInput("active", function(inputData) {
    ...
    var position1Entity = Instance.FindEntityByName("missile_vehicle_missile_track_3");
    var position2Entity = Instance.FindEntityByName("missile_vehicle_missile_train");
    var arrowEntity = Instance.FindEntityByName("missile_vehicle_missile_train");
