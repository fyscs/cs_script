...
// 文本模板
const TEMPLATES = {
    gatebreak: "Gate will break in {time} sec",
    gateopen: "Gate will open in {time} sec",
    elevator: "Elevator leave in {time} sec",
    dooropen: "Door open in {time} sec",
    doorbreak: "Door breaks in {time} sec",
    portal: "Portal {time}",
    boat: "Boat sails to Kurast {time}",
    destiny: "DESTINY AWAITS >> {time} <<",
    liftrise: "Lift will rise in {time} seconds",
    no: ">>>  {time}  <<<",
    elevatora: "Elevator ascends in {time} sec",
};
...
// 预设倒计时
[
    "gatebreak_30","gatebreak_15","gatebreak_20","no_20","gatebreak_25",
    "gateopen_10","gateopen_15","gateopen_20","gateopen_25","gateopen_30",
    "elevator_15","boat_20","liftrise_20","no_30","elevatora_35",
    "dooropen_15","destiny_20","dooropen_20","no_40",
    "doorbreak_20","portal_25",
    "portal_20","portal_30",
].forEach(preset => {
