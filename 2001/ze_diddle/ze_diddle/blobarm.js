...
//===================================\\
// Blob Arm script by Luffaren (STEAM_0:1:22521282)
// CS2 Port - manager.ts style, only Death and SpawnArms
// ===================================\\
...
function Death() {
    blobtimer += 2.00;
    Instance.EntFireAtName({ name: "blobb_timer", input: "UpperRandomBound", value: blobtimer.toString() });
    Instance.EntFireAtName({ name: "blobb_timer", input: "LowerRandomBound", value: (blobtimer / 3).toString() });
}
function SpawnArms() {
    const spawns = [
        { delay: 0.00, origin: "9393 3348 -1154", angles: "60 -50 0" },
        { delay: 0.10, origin: "11047 4811 -2052", angles: "55 -47 100" },
        { delay: 0.20, origin: "11032 4780 94", angles: "-33 -57 45" },
        { delay: 0.30, origin: "12639 4684 -1658", angles: "8 -102 70" },
        { delay: 0.40, origin: "13577 3640 -2852", angles: "55 -170 260" },
        { delay: 0.50, origin: "11124 4600 -2259", angles: "-30 -50 120" },
        { delay: 0.60, origin: "12638 4765 -2515", angles: "-10 -70 180" },
        { delay: 0.70, origin: "12953 4076 -18", angles: "25 -108 0" },
        { delay: 0.80, origin: "11146 4779 -1961", angles: "-5 -25 -45" },
        { delay: 0.90, origin: "13645 3317 -1460", angles: "0 -120 0" },
        { delay: 1.00, origin: "12465 3855 1844", angles: "56 -150 270" },
        { delay: 1.10, origin: "9850 3551 1113", angles: "28 -33 270" },
        { delay: 1.20, origin: "11226 4624 1804", angles: "13 -35 -20" },
        { delay: 1.30, origin: "13536 2172 -1871", angles: "4 163 45" },
        { delay: 1.40, origin: "12903 3820 -464", angles: "-24 -118 15" },
        { delay: 1.50, origin: "12903 3820 -464", angles: "-24 -118 15" },
        { delay: 1.60, origin: "8919 2787 -1831", angles: "1 -12 25" },
        { delay: 1.70, origin: "9911 1940 -50", angles: "2 26 0" },
        { delay: 1.80, origin: "13318 5012 -2604", angles: "-46 -130 0" },
        { delay: 1.90, origin: "13764 2449 -2987", angles: "29 163 0" },
        { delay: 2.00, origin: "13153 4319 -1497", angles: "32 -145 180" },
    ];
    for (const spawn of spawns) {
        Instance.EntFireAtName({ name: "s_blobarm", input: "KeyValues", value: "origin " + spawn.origin, delay: spawn.delay });
        Instance.EntFireAtName({ name: "s_blobarm", input: "KeyValues", value: "angles " + spawn.angles, delay: spawn.delay });
        Instance.EntFireAtName({ name: "s_blobarm", input: "ForceSpawn", delay: spawn.delay + 0.05 });
    }
}
// ---------- 处理器函数 ----------
...
function handleSpawnArms() {
    SpawnArms();
}
// ---------- 外部输入别名列表 ----------
const EXTERNAL_INPUT_ALIASES = [
    input("Death", "Death()", handleDeath, "vmf", "Trigger death animation and update timer"),
    input("SpawnArms", "SpawnArms()", handleSpawnArms, "vmf", "Spawn multiple blob arms with predefined positions"),
];
// ---------- 注册函数 ----------
function registerInputAliases() {
    ...
    //Instance.Msg(`[BlobArm] Registered ${EXTERNAL_INPUT_ALIASES.length} inputs\n`);
}
// 顶层执行注册
