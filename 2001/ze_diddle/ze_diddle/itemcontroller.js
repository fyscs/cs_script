...
function SetDistcheck(inputData) {
    distcheck = requireEntity(inputData.caller, 'SetDistcheck caller');
}
function SetBackup(inputData) {
    backup = requireEntity(inputData.caller, 'SetBackup caller');
}
function SetBase(inputData) {
    base = requireEntity(inputData.caller, 'SetBase caller');
}
function SetPistol(inputData) {
    pistol = requireEntity(inputData.caller, 'SetPistol caller');
}
function KillItem() {
    if (!killed) {
...
const EXTERNAL_INPUT_ALIASES = [
    ...
    input('SetDistcheck', 'SetDistcheck()', (inputData) => SetDistcheck(inputData), 'vmf'),
    input('SetBackup', 'SetBackup()', (inputData) => SetBackup(inputData), 'vmf'),
    input('SetBase', 'SetBase()', (inputData) => SetBase(inputData), 'vmf'),
    input('SetPistol', 'SetPistol()', (inputData) => SetPistol(inputData), 'vmf'),
    input('KillItem', 'KillItem()', () => KillItem(), 'vmf+stripper'),
