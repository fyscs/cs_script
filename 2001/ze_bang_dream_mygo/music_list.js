...
let currentMusic = "";
const musicList = ["RaiseUpYourBat", "SuiHua", "UmapyoiDensetsu", "GongXiFaCai", "TheTaleOfACruelWorld", "NewYorkBackRaise", "TheFarSideStarSFarewell", "InternetYamero", "DearYou", "BraveShine", "SongIAm", "FireBird", "Odysseus", "ShukuseiLoliKamiRequiem", "Miiro", "NceSBurn", "MortalWithYou", "UniversalCollapse", "NeoAspect", "TakeRisshu", "DistortedFate", "RageStrikes", "IAlwaysDo", "MaleFemale", "DaDongBei", "Louder", "NamelessPassion", "BeethovenVirus", "YukiNoShizukuAmeNoOto", "TVsShark", "Oborozuki", "Jericho", "KimitoatsumatteSeizaninaretara", "MusicaCaelestis", "SeeYouAgain", "HatedByLife", "InternetOverdose", "FeastOfMouse", "CornerstoneCorolla", "Tanebi", "ImprisonedXII", "Refrain", "SilhouetteDance", "SpringSunshine", "Encoder", "NamaeNoNaiKaibutsu", "TheTempest", "TengokuJigokuguni", "Mayoiuta", "Hitoshizuku", "BeepBeepImASheep", "TheOtherSide", "MyDemons", "Mujinku", "Rrharil", "Terrasphere", "DossolesHoliday"];
const playedMusic = /** @type {Array<string>} */ ([]);

// 设置最新谱面
Instance.OnScriptInput("New", (inputData) => {
    currentMusic = "DaKeJian";
