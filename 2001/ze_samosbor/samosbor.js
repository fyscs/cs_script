...
const Inputs = [
  ['Admin_ResetToDefault', 'OnPressed', '', ResetVariables, 0.0],
  ['Admin_HP_Sub1', 'OnPressed', '1', ChangeHealth, 0.0],
  ['Admin_HP_Sub5', 'OnPressed', '5', ChangeHealth, 0.0],
  ['Admin_HP_Add1', 'OnPressed', '-1', ChangeHealth, 0.0],
  ['Admin_HP_Add5', 'OnPressed', '-5', ChangeHealth, 0.0],
  ['Admin_MaxHP_Sub1', 'OnPressed', '1', ChangeMaxHealth, 0.0],
  ['Admin_MaxHP_Sub5', 'OnPressed', '5', ChangeMaxHealth, 0.0],
  ['Admin_MaxHP_Add1', 'OnPressed', '-1', ChangeMaxHealth, 0.0],
  ['Admin_MaxHP_Add5', 'OnPressed', '-5', ChangeMaxHealth, 0.0],
  ['Admin_MaxMiniBosses_Sub1', 'OnPressed', '1', ChangeMaxMiniBosses, 0.0],
  ['Admin_MaxMiniBosses_Add1', 'OnPressed', '-1', ChangeMaxMiniBosses, 0.0],
  ['Admin_MaxFloors_Sub1', 'OnPressed', '1', ChangeMaxFloors, 0.0],
  ['Admin_MaxFloors_Add1', 'OnPressed', '-1', ChangeMaxFloors, 0.0],
  ['Admin_Traps_Sub1', 'OnPressed', '1', ChangeTrapsAmount, 0.0],
  ['Admin_Traps_Sub5', 'OnPressed', '5', ChangeTrapsAmount, 0.0],
  ['Admin_Traps_Add1', 'OnPressed', '-1', ChangeTrapsAmount, 0.0],
  ['Admin_Traps_Add5', 'OnPressed', '-5', ChangeTrapsAmount, 0.0],
  ['Admin_NPCs_Sub1', 'OnPressed', '1', ChangeNPCsAmount, 0.0],
  ['Admin_NPCs_Sub5', 'OnPressed', '5', ChangeNPCsAmount, 0.0],
  ['Admin_NPCs_Add1', 'OnPressed', '-1', ChangeNPCsAmount, 0.0],
  ['Admin_NPCs_Add5', 'OnPressed', '-5', ChangeNPCsAmount, 0.0],
  ['Admin_ExitGlow_Disable', 'OnPressed', '0', ChangeExitGlow, 0.0],
  ['Admin_ExitGlow_Enable', 'OnPressed', '1', ChangeExitGlow, 0.0],
  [
    'Admin_LightningStrikes_Disable',
    'OnPressed',
    '0',
    ChangeLightningStrikes,
    0.0,
  ],
  [
    'Admin_LightningStrikes_Enable',
    'OnPressed',
    '1',
    ChangeLightningStrikes,
    0.0,
  ],
  ['Admin_FallDamage_Disable', 'OnPressed', '0', ChangeFallDamage, 0.0],
  ['Admin_FallDamage_Enable', 'OnPressed', '1', ChangeFallDamage, 0.0],
  ['Admin_FakeExits_Disable', 'OnPressed', '0', ChangeFakeExits, 0.0],
  ['Admin_FakeExits_Enable', 'OnPressed', '1', ChangeFakeExits, 0.0],
  ['Admin_DeadEndChunks_Disable', 'OnPressed', '0', ChangeDeadEndChunks, 0.0],
  ['Admin_DeadEndChunks_Enable', 'OnPressed', '1', ChangeDeadEndChunks, 0.0],
  ['Admin_MiniBosses_Disable', 'OnPressed', '0', ChangeMiniBosses, 0.0],
  ['Admin_MiniBosses_Enable', 'OnPressed', '1', ChangeMiniBosses, 0.0],
  ['Admin_ExtremeMode_Disable', 'OnPressed', '0', ChangeExtremeMode, 0.0],
  ['Admin_ExtremeMode_Enable', 'OnPressed', '1', ChangeExtremeMode, 0.0],
  ['Admin_VipMode_Disable', 'OnPressed', '0', ChangeVipMode, 0.0],
  ['Admin_VipMode_Enable', 'OnPressed', '1', ChangeVipMode, 0.0],
  ['Admin_ChunksShuffle_Disable', 'OnPressed', '0', ChangeChunksShuffle, 0.0],
  ['Admin_ChunksShuffle_Enable', 'OnPressed', '1', ChangeChunksShuffle, 0.0],
  ['Admin_SamosborTimer_Disable', 'OnPressed', '0', ChangeSamosborTimer, 0.0],
  ['Admin_SamosborTimer_Enable', 'OnPressed', '1', ChangeSamosborTimer, 0.0],
  ['Admin_SamosborTime_Sub1', 'OnPressed', '60', ChangeSamosborTime, 0.0],
  ['Admin_SamosborTime_Add1', 'OnPressed', '-60', ChangeSamosborTime, 0.0],
  ['Admin_SamosborDamage_Sub1', 'OnPressed', '1', ChangeSamosborDamage, 0.0],
  ['Admin_SamosborDamage_Add1', 'OnPressed', '-1', ChangeSamosborDamage, 0.0],
  [
    'Admin_ElevatorHumansCheck_Disable',
    'OnPressed',
    '0',
    ChangeElevatorHumansCheck,
    0.0,
  ],
  [
    'Admin_ElevatorHumansCheck_Enable',
    'OnPressed',
    '1',
    ChangeElevatorHumansCheck,
    0.0,
...
const SKINS_LIST = [
  ...
  {
    number: 2,
    path: 'agents/models/waffel/kipfel/kipfel_ghostcandy/kipfel_ghostcandy.vmdl',
  },
  {
    number: 3,
    path: 'agents/models/waffel/kipfel/kipfel_cherry/kipfel_cherry.vmdl',
  },
]
...
const ADMIN_NUMERIC = [
  ...
  {
    key: 'traps',
    fn: () => ChangeTrapsAmount,
    steps: ['5', '1'],
    get: () => pre_traps_percentage,
  },
  {
    key: 'samosbortime',
    fn: () => ChangeSamosborTime,
    steps: ['60'],
    get: () => pre_samosbortime,
  },
  {
    key: 'samosbordamage',
    fn: () => ChangeSamosborDamage,
    steps: ['1'],
    get: () => pre_samosbordamage,
  },
]
...
const ADMIN_TOGGLES = [
  { key: 'exitglow', fn: () => ChangeExitGlow, get: () => pre_isExitGlow },
  {
    ...
    fn: () => ChangeLightningStrikes,
    get: () => pre_isLightningStrikes,
  },
  {
    key: 'falldamage',
    fn: () => ChangeFallDamage,
    get: () => pre_isFallDamage,
  },
  { key: 'fakeexits', fn: () => ChangeFakeExits, get: () => pre_isFakeExits },
  {
    key: 'deadendchunks',
    fn: () => ChangeDeadEndChunks,
    get: () => pre_isDeadEndChunks,
  },
  {
    key: 'minibosses',
    fn: () => ChangeMiniBosses,
    get: () => pre_isMiniBosses,
  },
  // { key: "extrememode",         fn: () => ChangeExtremeMode,         get: () => isExtremeMode },
  { key: 'vipmode', fn: () => ChangeVipMode, get: () => pre_isVipMode },
  {
    key: 'chunksshuffle',
    fn: () => ChangeChunksShuffle,
    get: () => pre_isChunksShuffle,
  },
  {
    key: 'samosbortimer',
    fn: () => ChangeSamosborTimer,
    get: () => pre_isSamosborTimer,
  },
  {
    key: 'elevatorhumanscheck',
    fn: () => ChangeElevatorHumansCheck,
    get: () => pre_isElevatorHumansCheck,
  },
]
...
const SURVIVAL_DEST_CHECK_TICK = 1.0
...
const ZM_ITEM_PLAYER_NAMES = [
  'player_zm_nailgun',
  'player_zm_suicide',
  'player_zm_flamethrower',
]
...
const SLOT_TICK_CYCLE =
  SLOT_TICK_GAP + SLOT_TICK_SCROLL_DURATION + SLOT_TICK_GAP // ≈0.17s

const SLOT_REEL_FRAME_IDS = [
  'slot_reel_left',
  'slot_reel_center',
  'slot_reel_right',
]
...
const MODE_DEFS = [
  {
    enabled: true,
    name: 'EASY MODE',
    desc: 'One way open max. Standard rules apply. A relaxed run.',
  },
  {
    enabled: true,
    name: 'NORMAL MODE',
    desc: 'All ways can be possibly be open. Standard rules apply.',
  },
  {
    enabled: true,
    name: 'EXTREME MODE',
    desc: 'Includes a timer before SAMOSBOR. 6 Floors.',
  },
  {
    enabled: false,
    name: 'LIQUIDATION MODE',
    desc: 'Survive as long as possible. Find the canister and escape the floor.',
  },
]
...
function UpdateVotingTimeLabel(now) {
  ...
  HUD_ENT.SetDialogVariableString(
    'voting_time_label',
    'time_left',
    FormatTime(voteEndTime - now),
  )
}
...
function EndVoting() {
  ...
  for (let i = 0; i < WRAPPER_IDS.length; i++) {
    ...
    HUD_ENT.SetHasClass(
      WRAPPER_IDS[i],
      'VoteLoser',
      currentButtonModes[i] !== null && !isWinner,
    )
  }
  ...
  Instance.Delay(3.0).then(() => {
    ...
    if (
      MODE_DEFS[previousActiveModeIndexHolder] &&
      MODE_DEFS[previousActiveModeIndexHolder].enabled
    ) {
...
function SetModeEnabled(modeIndex, enabled) {
  ...
  if (!enabled) {
    ...
    !currentButtonModes.includes(modeIndex)
  ) {
    for (let i = 0; i < 3; i++) {
...
Instance.OnCustomHudClicked((event) => {
  ...
  if (buttonId === 'menu_open_btn') {
    OpenBigMenu(playerSlot, inst)
    return
  }
  if (buttonId === 'menu_close_btn') {
    CloseBigMenu(playerSlot, inst)
    return
  }

  for (const t of MENU_TABS) {
    if (buttonId === 'tab_btn_' + t) {
      SetMenuTab(playerSlot, inst, t)
      return
    }
  }

  for (const c of SKIN_CARDS) {
    if (buttonId === 'skin_card_' + c.key) {
      ApplySkin(playerSlot, inst, c.key)
      return
    }
  }
...
function ShowSlotResult(isWin, itemIndex) {
  ...
  if (isWin) {
    ...
    Instance.EntFireAtName({
      name: 'Map_Slot_Machine_Win_Sound',
      input: 'StartSound',
    })
    ...
    Instance.Delay(3.0).then(() => {
      ...
      if (itemIndex === 0) Temp_Item_Beer.ForceSpawn(pos)
        ...
        const logic_case = (temp ?? []).filter(
          (ent) => ent?.IsValid() && ent.GetClassName() === 'logic_case',
        )[0]
    ...
    Instance.EntFireAtName({
      name: 'Map_Slot_Machine_WinParticle',
      input: 'Start',
      delay: 3.0,
    })
    Instance.EntFireAtName({
      name: 'Map_Slot_Machine_WinSound',
      input: 'StartSound',
      delay: 3.0,
    })
    Instance.EntFireAtName({
    ...
    Instance.EntFireAtName({
      name: 'Map_Slot_Machine_Lose_Sound',
      input: 'StartSound',
    })
  }
...
function SlotReelTick(state, remainingTicks, finalItemIndex) {
  ...
  Instance.EntFireAtName({
    name: 'Map_Slot_Machine_Tick_Sound',
    input: 'StartSound',
  })
...
function PlaySlotMachine(caller) {
  ...
  Instance.EntFireAtTarget({ target: caller, input: 'Unlock', delay: 9.0 })

  Instance.EntFireAtName({
    name: 'Map_Slot_Machine_Pull_Sound',
    input: 'StartSound',
  })
  ...
  Instance.EntFireAtName({
    name: 'Map_Slot_Machine_Result_Sound',
    input: 'StartSound',
    delay: 3.2,
  })
...
Instance.SetThink(function () {
  ...
  for (const [slot, inst] of PlayerInstancesMap) {
    ...
    if (
      inst.HudScoreOverlayOpen &&
      player.WasInputJustReleased(CSInputs.SHOW_SCORES)
    ) {
    ...
    if (
      player.WasInputJustPressed(CSInputs.SHOW_SCORES) &&
      !player.IsInputPressed(CSInputs.WALK) &&
      !inst.HudMainMenuOpen &&
      !inst.HudRadarOpen &&
      !votingActive &&
    ...
    if (
      ...
      HUD_ENT.SetInputCaptureEnabled(
        slot,
        inst.HudScoreOverlayOpen || inst.HudMainMenuOpen,
      )
...
Instance.OnPlayerReset((event) => {
  ...
  if (player?.IsValid()) {
    ...
    if (PlayerInstancesMap.has(player_slot)) {
      ...
      if (inst.Mapper || inst.Vip || inst.Sponsor) {
        if (inst.Skin != '' && player.GetTeamNumber() === 3) {
          Instance.EntFireAtTarget({
            target: inst.player,
            input: 'SetModel',
            value: ResolveSkinPath(inst.Skin),
            delay: 1.0,
          })
        }
      ...
      PlayerInstancesMap.set(
        player_slot,
        new Player(player, player_controller, player_name, player_slot),
      )
    }
...
Instance.OnRoundStart(() => {
  ...
  Instance.Delay(1.2).then(() => {
    Instance.ServerCommand(`say < Map Version: ${VERSION} >`)
  })
  ...
  if (isSurvivalMode) {
    ...
    Instance.EntFireAtName({
      name: 'Spawn_SurvivalMode_Elevator_Check',
      input: 'Enable',
    })
    Instance.EntFireAtName({
      name: 'Spawn_SurvivalMode_ZM_Push',
      input: 'Enable',
    })
    Instance.EntFireAtName({
      name: 'Spawn_SurvivalMode_ZM_Teleport',
      input: 'Enable',
    })
    Instance.EntFireAtName({
      name: 'Spawn_Elevator_Out_Button',
      input: 'Lock',
      delay: 1.0,
    })
    Instance.EntFireAtName({
  ...
  if (Inputs.length > 0) {
    for (let i = 0; i < Inputs.length; i++) {
      ...
      Instance.Msg(
        `Add Output to: ${entName} | OutputName: ${outputName} | Param: ${param} | Func: ${handlerFn.name} | Delay: ${delay}`,
      )

      Instance.ConnectOutput(
        ent,
        outputName,
        ({ value = param, caller, activator }) => {
          Delay(function () {
            handlerFn(value)
          }, delay)
        },
...
Instance.OnModifyPlayerDamage((event) => {
  ...
  if (isVotingForMode) {
    if (
      isVotingImmunity &&
      inflictor.GetClassName() == 'player' &&
      inflictor.GetTeamNumber() == 2
    ) {
      return { abort: true }
    }
  }
  ...
  if (isSurvivalMode) {
    if (
      ...
      player.TakeDamage({
        damage: SURVIVAL_ZOMBIE_DAMAGE,
        damageTypes: CSDamageTypes.SONIC,
        inflictor: attacker,
        weapon: recursive_fix,
      })
      return { abort: true }
  ...
  if (
    inflictor?.GetClassName() == 'prop_physics' ||
    inflictor?.GetClassName() == 'prop_physics_override' ||
    inflictor?.GetClassName() == 'func_physbox'
  ) {
    let damage = 0
    return { damage }
  }
...
Instance.OnPlayerChat((event) => {
  ...
  if (
    ...
    !player_controller.GetPlayerPawn()?.IsValid() ||
    !player_controller.IsAlive()
  ) {
    return
  }
  const player_slot = player_controller?.GetPlayerSlot()
  ...
  if (player_text.includes('!m_skin')) {
    if (inst.Mapper) {
      ...
      if (
        Number(text[1]) &&
        Number(text[1]) > 0 &&
        Number.isInteger(Number(text[1])) &&
        Number(text[1]) <= SKINS_LIST.length
      ) {
        let skin_path = SKINS_LIST.find(
          (item) => item.number == Number(text[1]),
        )
  ...
  if (
    player_text.includes('!m_survivalfloors') &&
    (inst.Mapper || inst.Leader)
  ) {
    const text = player_text.split(' ')
    const value = Number(text[1])
    if (!isNaN(value) && value > 0) {
  ...
  if (caller?.IsValid() && caller?.GetClassName() == 'env_entity_maker') {
    ...
    if (rnd == 1) {
      ...
      Instance.EntFireAtTarget({
        target: caller,
        input: 'KeyValue',
        value: `angles 0 ${Math.round(angles.yaw)} 0`,
      })
    }
    if (rnd == 2) {
      ...
      Instance.EntFireAtTarget({
        target: caller,
        input: 'KeyValue',
        value: `angles 0 ${Math.round(angles.yaw) + 180} 0`,
      })
    }
  }
})
...
Instance.OnScriptInput('PickRandomDoor', ({ caller, activator }) => {
  ...
  if (isEasyMode) {
    if (
      ...
      if (MapEntrancesCount >= MapEntrancesCount_Max) {
        Instance.EntFireAtName({
          name: `Door_Maker${suffix}`,
          input: 'KeyValue',
          value: 'EntityTemplate Door_Temp_C',
        })
        return
      }
      MapEntrancesCount += 1
  ...
  if (door?.value == 0) {
    Instance.EntFireAtName({
      name: `Door_Maker${suffix}`,
      input: 'KeyValue',
      value: 'EntityTemplate Door_Open_Temp_a',
    })
  }
  if (door?.value == 1) {
    Instance.EntFireAtName({
      name: `Door_Maker${suffix}`,
      input: 'KeyValue',
      value: 'EntityTemplate Door_Open_Temp_b',
    })
  }
  if (door?.value == 2) {
    Instance.EntFireAtName({
      name: `Door_Maker${suffix}`,
      input: 'KeyValue',
      value: 'EntityTemplate Door_Open_Temp_c',
    })
  }
})
...
Instance.OnScriptInput('SamosborBoolsEnableBack', () => {
  // JUST TO BE SAFE NOTHING GOES WRONG
  isSamosborHurt = true
...
Instance.OnScriptInput('ShowSamosborTimer', ({ caller, activator }) => {
  ...
  Instance.EntFireAtName({
    name: 'Map_Samosbor_Hudhint',
    input: 'SetMessage',
    value: `[SAMOSBOR WARNING]\n00:${mm}:${ss}`,
  })
  ...
  if (samosbortime_floor === 12) {
    Instance.EntFireAtName({
      name: 'Map_Samosbor_Prepare_Relay',
      input: 'Trigger',
    })
  }
...
Instance.OnScriptInput('SpawnGift', ({ caller, activator }) => {
  if (caller?.IsValid && caller.GetClassName() == 'trigger_multiple') {
    ...
    if (gift_item?.value == 0) {
      Instance.EntFireAtName({
        name: 'Map_GiftBox_Maker',
        input: 'KeyValue',
        value: 'EntityTemplate Item_Beer_Template',
      })
      Instance.EntFireAtName({
        name: 'Map_GiftBox_Maker',
        input: 'ForceSpawnAtEntityOrigin',
    ...
    if (gift_item?.value == 1) {
      Instance.EntFireAtName({
        name: 'Map_GiftBox_Maker',
        input: 'KeyValue',
        value: 'EntityTemplate Item_Beans_Template',
      })
      Instance.EntFireAtName({
        name: 'Map_GiftBox_Maker',
        input: 'ForceSpawnAtEntityOrigin',
    ...
    if (gift_item?.value == 2) {
      Instance.EntFireAtName({
        name: 'Map_GiftBox_Maker',
        input: 'KeyValue',
        value: 'EntityTemplate Map_Elevator_Mine_Template',
      })
      Instance.EntFireAtName({
        name: 'Map_GiftBox_Maker',
        input: 'ForceSpawnAtEntityOrigin',
    ...
    if (gift_item?.value == 3) {
      Instance.EntFireAtName({
        name: 'Map_GiftBox_Maker',
        input: 'KeyValue',
        value: 'EntityTemplate Item_Whip_Template',
      })
      Instance.EntFireAtName({
        name: 'Map_GiftBox_Maker',
        input: 'ForceSpawnAtEntityOrigin',
    ...
    if (gift_item?.value == 4) {
      Instance.EntFireAtName({
        name: 'Map_GiftBox_Maker',
        input: 'KeyValue',
        value: 'EntityTemplate Item_FlareGun_Template',
      })
      Instance.EntFireAtName({
        name: 'Map_GiftBox_Maker',
        input: 'ForceSpawnAtEntityOrigin',
...
Instance.OnScriptInput('SpawnTrap', () => {
  ...
  let trap_makers = makers.filter(
    (maker) => maker.GetEntityName().search('_Trap_Maker_') != -1,
  )
...
Instance.OnScriptInput('SpawnBottleBox', () => {
  let makers = Instance.FindEntitiesByClass('env_entity_maker')
  let bottlebox_makers = makers.filter(
    (maker) => maker.GetEntityName().search('_Bottle_Maker_') != -1,
  )
...
Instance.OnScriptInput('BottleBoxDamageFilter', ({ caller, activator }) => {
  if (!isSurvivalMode) return
    ...
    const suffix = caller_name?.slice(caller_name.lastIndexOf('_'))
    Instance.EntFireAtName({
      name: `BottleCrate_Phys${suffix}`,
      input: 'SetDamageFilter',
      value: 'Filter_Team_Human',
    })
  }
})
  ...
  if (caller?.IsValid()) {
    if (!isSurvivalMode) return
      ...
      Instance.EntFireAtTarget({
        target: caller,
        input: 'KeyValue',
        value: 'filtername Filter_Team_Human',
      })
    }
  }
})
  ...
  ({ caller, activator }) => {
    if (!isSurvivalMode) {
      ...
      Instance.EntFireAtName({
        name: SCRIPT_ENT,
        input: 'RunScriptInput',
        value: 'TeleportToRandomDestination',
        activator: activator,
      })
    }
  },
...
Instance.OnScriptInput('SpawnFire', () => {
  if (floor_type_fire) {
    let makers = Instance.FindEntitiesByClass('env_entity_maker')
    let trap_makers = makers.filter(
      (maker) => maker.GetEntityName().search('_Fire_Maker') != -1,
    )
    ...
    for (let i = 0; i < traps_amount; i++) {
      ...
      if (r_ent?.IsValid()) {
        Instance.EntFireAtTarget({
          target: r_ent,
          input: 'KeyValue',
          value: 'EntityTemplate Map_Snow_Template',
          delay: 0.0,
        })
        Instance.EntFireAtTarget({
          target: r_ent,
    ...
    if (!isSurvivalMode) {
      ...
      if (!isMiniBossFight) {
        ...
        if (floor <= floors_max - 1) {
          ...
          activator.Teleport({
            position: { x: -527, y: 0, z: 13325 },
            angles: { pitch: 0, yaw: 0, roll: 0 },
          })
        }
        if (floor == floors_max && meat < meat_max) {
          // Normal Ending
          activator.Teleport({
            position: { x: 7488, y: -11264, z: -12974 },
            angles: { pitch: 0, yaw: 0, roll: 0 },
          })
        }
        if (floor == floors_max && meat >= meat_max) {
          // Secret Ending
          activator.Teleport({
            position: { x: -7200, y: -3352, z: -7748 },
            angles: { pitch: 0, yaw: 270, roll: 0 },
          })
        }
      }
      if (isMiniBossFight) {
        ...
        if (MINI_BOSS == 'WORM') {
          activator.Teleport({
            position: { x: 10592, y: 0, z: -15358 },
            angles: { pitch: 0, yaw: 0, roll: 0 },
          })
        }
        if (MINI_BOSS == 'BOSS') {
          activator.Teleport({
            position: { x: 10752, y: 0, z: -15360 },
            angles: { pitch: 0, yaw: 0, roll: 0 },
          })
        }
      }
...
Instance.OnScriptInput('TeleportZombiesMiniBoss', ({ caller, activator }) => {
  if (activator?.IsValid() && activator?.GetClassName() == 'player') {
    if (MINI_BOSS == 'WORM') {
      activator.Teleport({
        position: { x: 12560, y: 0, z: -14574 },
        angles: { pitch: 0, yaw: 180, roll: 0 },
      })
    }
  }
})
...
Instance.OnScriptInput('ResetHumanHealth', () => {
  ...
  for (let i = 0; i < players_human.length; i++) {
    ...
    Instance.EntFireAtTarget({
      target: player,
      input: 'KeyValue',
      value: 'max_health ' + human_max_hp,
      delay: 0.0,
    })
    Instance.EntFireAtTarget({
      target: player,
      input: 'KeyValue',
      value: 'health ' + human_hp,
      delay: 0.0,
    })
  }
})
...
Instance.OnScriptInput('PlayerVoteForMode', ({ caller, activator }) => {
  ...
  if (floor == 0) {
    if (
      isVoteForChangingMode &&
      !isVoteForChangingModeSucceeded &&
      !inst.voted_for_changing_mode
    ) {
...
Instance.OnScriptInput('SpawnFakeElevator', () => {
  ...
  let door_replace = doors.filter((door) => {
    ...
    if (
      r_ent_origin.x >= 15340 ||
      r_ent_origin.x <= -15340 ||
      r_ent_origin.y >= 15340 ||
      r_ent_origin.y <= -15340
    ) {
      return false
    }
  ...
  Instance.EntFireAtName({
    name: 'Map_FakeElevator_Maker',
    input: 'KeyValue',
    value: `origin ${r_ent_origin.x} ${r_ent_origin.y} ${r_ent_origin.z}`,
  })
  if (Math.round(r_ent_angles.yaw) == -180) {
    Instance.EntFireAtName({
      name: 'Map_FakeElevator_Maker',
      input: 'KeyValue',
      value: `angles 0 270 0`,
    })
  } else {
    Instance.EntFireAtName({
      name: 'Map_FakeElevator_Maker',
      input: 'KeyValue',
      value: `angles 0 ${Math.round(r_ent_angles.yaw) - 270} 0`,
    })
  }
...
Instance.OnScriptInput('SpawnDeadEnd', () => {
  ...
  Instance.EntFireAtName({
    name: 'Preset_DeadEnd_Maker',
    input: 'KeyValue',
    value: 'EntityTemplate Door_Temp',
  })
  Instance.EntFireAtName({
    name: 'Preset_DeadEnd_Maker',
    input: 'ForceSpawn',
  ...
  Instance.EntFireAtName({
    name: 'Preset_DeadEnd_Maker',
    input: 'KeyValue',
    value: 'EntityTemplate Temp_DeadEnd',
    delay: 0.04,
  })
  Instance.EntFireAtName({
    name: 'Preset_DeadEnd_Maker',
...
Instance.OnScriptInput('CheckVipPlayer', ({ caller, activator }) => {
  ...
  if (
    ...
    for (let i = 0; i < players_human.length; i++) {
      let player = players_human[i]
      player.SetHealth(
        player.GetHealth() - Math.floor(player.GetHealth() * 0.7),
      )
    }
  }
  if (!isVipDead) {
...
Instance.OnScriptInput('SpawnItemInShop', ({ caller, activator }) => {
  ...
  if (item?.value == 0) {
    Instance.EntFireAtName({
      name: `Map_Chunk_Store_Maker_${side[1]}${suffix}`,
      input: 'KeyValue',
      value: 'EntityTemplate Item_Canister_Template',
    })
    Instance.EntFireAtName({
      name: `Map_Chunk_Store_SampleMaker_${side[1]}${suffix}`,
      input: 'KeyValue',
      value: 'EntityTemplate Sample_Canister_Template',
    })
    Instance.EntFireAtName({
      name: `Map_Chunk_Store_SampleMaker_${side[1]}${suffix}`,
      input: 'ForceSpawn',
    ...
    Instance.EntFireAtName({
      name: `Map_Chunk_Store_PriceText_${side[1]}${suffix}`,
      input: 'SetMessage',
      value: price,
    })
    if (price == 8) {
  ...
  if (item?.value == 1) {
    Instance.EntFireAtName({
      name: `Map_Chunk_Store_Maker_${side[1]}${suffix}`,
      input: 'KeyValue',
      value: 'EntityTemplate Item_Spanner_Template',
    })
    Instance.EntFireAtName({
      name: `Map_Chunk_Store_SampleMaker_${side[1]}${suffix}`,
      input: 'KeyValue',
      value: 'EntityTemplate Sample_Spanner_Template',
    })
    Instance.EntFireAtName({
      name: `Map_Chunk_Store_SampleMaker_${side[1]}${suffix}`,
      input: 'ForceSpawn',
  ...
  if (item?.value == 2) {
    ...
    Instance.EntFireAtName({
      name: `Map_Chunk_Store_SampleMaker_${side[1]}${suffix}`,
      input: 'KeyValue',
      value: 'EntityTemplate Sample_Beans_Template',
    })
    Instance.EntFireAtName({
      name: `Map_Chunk_Store_SampleMaker_${side[1]}${suffix}`,
      input: 'ForceSpawn',
  ...
  if (item?.value == 3) {
    ...
    Instance.EntFireAtName({
      name: `Map_Chunk_Store_SampleMaker_${side[1]}${suffix}`,
      input: 'KeyValue',
      value: 'EntityTemplate Sample_Beer_Template',
    })
    Instance.EntFireAtName({
      name: `Map_Chunk_Store_SampleMaker_${side[1]}${suffix}`,
      input: 'ForceSpawn',
  ...
  if (item?.value == 4) {
    ...
    Instance.EntFireAtName({
      name: `Map_Chunk_Store_SampleMaker_${side[1]}${suffix}`,
      input: 'KeyValue',
      value: 'EntityTemplate Sample_FlareGun_Template',
    })
    Instance.EntFireAtName({
      name: `Map_Chunk_Store_SampleMaker_${side[1]}${suffix}`,
      input: 'ForceSpawn',
  ...
  if (item?.value == 5) {
    Instance.EntFireAtName({
      name: `Map_Chunk_Store_Maker_${side[1]}${suffix}`,
      input: 'KeyValue',
      value: 'EntityTemplate Item_PPSh_Template',
    })
    Instance.EntFireAtName({
      name: `Map_Chunk_Store_SampleMaker_${side[1]}${suffix}`,
      input: 'KeyValue',
      value: 'EntityTemplate Sample_PPSh_Template',
    })
    Instance.EntFireAtName({
      name: `Map_Chunk_Store_SampleMaker_${side[1]}${suffix}`,
      input: 'ForceSpawn',
...
Instance.OnScriptInput('PurchaseItem', ({ caller, activator }) => {
  ...
  if (BOTTLES >= price) {
    ...
    Instance.EntFireAtName({
      name: `Map_Chunk_Store_BuyRelay_${side[1]}${suffix}`,
      input: 'Trigger',
    })
  }
})
...
function ChangeMaxHealth(arg) {
  ...
  Instance.EntFireAtName({
    name: 'Admin_MaxHP_Value',
    input: 'SetMessage',
    value: pre_human_max_hp,
    delay: 0.0,
  })
}
...
function ChangeTrapsAmount(arg) {
  ...
  Instance.EntFireAtName({
    name: 'Admin_Traps_Value',
    input: 'SetMessage',
    value: pre_traps_percentage + '%',
    delay: 0.0,
  })
}
...
function ChangeNPCsAmount(arg) {
  ...
  Instance.EntFireAtName({
    name: 'Admin_NPCs_Value',
    input: 'SetMessage',
    value: pre_npcs_percentage + '%',
    delay: 0.0,
  })
}
...
function ChangeLightningStrikes(arg) {
  if (arg == '1') {
    ...
    Instance.EntFireAtName({
      name: 'Admin_LightningStrikes_Bool',
      input: 'SetMessage',
      value: 'ENABLED',
      delay: 0.0,
    })
...
function ChangeMaxMiniBosses(arg) {
  ...
  Instance.EntFireAtName({
    name: 'Admin_MaxMiniBosses_Value',
    input: 'SetMessage',
    value: pre_miniboss_max,
    delay: 0.0,
  })
}
...
function ChangeMaxFloors(arg) {
  ...
  Instance.EntFireAtName({
    name: 'Admin_MaxFloors_Value',
    input: 'SetMessage',
    value: pre_floors_max - 1,
    delay: 0.0,
  })
}
...
function ChangeSamosborTime(arg) {
  ...
  Instance.EntFireAtName({
    name: 'Admin_SamosborTime_Value',
    input: 'SetMessage',
    value: `${pre_samosbortime / 60} Minute(s)`,
    delay: 0.0,
  })
}
...
function ChangeSamosborDamage(arg) {
  ...
  Instance.EntFireAtName({
    name: 'Admin_SamosborDamage_Value',
    input: 'SetMessage',
    value: pre_samosbordamage,
    delay: 0.0,
  })
}
...
function ChangeElevatorHumansCheck(arg) {
  if (arg == '1') {
    ...
    Instance.EntFireAtName({
      name: 'Admin_ElevatorHumansCheck_Bool',
      input: 'SetMessage',
      value: 'ENABLED',
      delay: 0.0,
    })
...
Instance.OnScriptInput('LoadMode', () => {
  ...
  if (isSurvivalMode) {
    if (floor == 0) {
      ...
      Instance.EntFireAtName({
        name: 'Map_Chunk_Case_Even',
        input: 'AddOutput',
        value:
          'OnCase01>Preset_Maker_M*>KeyValue>EntityTemplate Temp_Chunk_02>0>-1',
      })
      Instance.EntFireAtName({
        name: 'Map_Chunk_CaseNotShuffle2',
        input: 'AddOutput',
        value:
          'OnCase02>Preset_Maker_M*>KeyValue>EntityTemplate Temp_Chunk_02>0>-1',
      })
      Instance.EntFireAtName({
        name: 'Map_Chunk_Case_Even',
        input: 'AddOutput',
        value:
          'OnCase02>Preset_Maker_M*>KeyValue>EntityTemplate Temp_Chunk_04>0>-1',
      })
      Instance.EntFireAtName({
        name: 'Map_Chunk_Case_Even',
        input: 'AddOutput',
        value:
          'OnCase04>Preset_Maker_M*>KeyValue>EntityTemplate Temp_Chunk_08>0>-1',
      })
      Instance.EntFireAtName({
        name: 'Map_Chunk_Case_Even',
        input: 'AddOutput',
        value:
          'OnCase13>Preset_Maker_M*>KeyValue>EntityTemplate Temp_Chunk_26>0>-1',
      })
      Instance.EntFireAtName({
        name: 'Map_Chunk_Case_Odd',
        input: 'AddOutput',
        value:
          'OnCase14>Preset_Maker_M*>KeyValue>EntityTemplate Temp_Chunk_27>0>-1',
      })
      Instance.EntFireAtName({
        name: 'Map_Chunk_CaseNotShuffle2',
        input: 'AddOutput',
        value:
          'OnCase04>Preset_Maker_M*>KeyValue>EntityTemplate Temp_Chunk_04>0>-1',
      })
      Instance.EntFireAtName({
        name: 'Map_Chunk_CaseNotShuffle2',
        input: 'AddOutput',
        value:
          'OnCase08>Preset_Maker_M*>KeyValue>EntityTemplate Temp_Chunk_08>0>-1',
      })
      Instance.EntFireAtName({
        name: 'Map_Chunk_CaseNotShuffle2',
        input: 'AddOutput',
        value:
          'OnCase26>Preset_Maker_M*>KeyValue>EntityTemplate Temp_Chunk_26>0>-1',
      })
      Instance.EntFireAtName({
        name: 'Map_Chunk_CaseNotShuffle2',
        input: 'AddOutput',
        value:
          'OnCase27>Preset_Maker_M*>KeyValue>EntityTemplate Temp_Chunk_27>0>-1',
      })
      Instance.EntFireAtName({
        name: 'Map_Chunk_Case_Odd',
        input: 'AddOutput',
        value:
          'OnCase06>Preset_Maker_M*>KeyValue>EntityTemplate Temp_Chunk_11>0>-1',
      })
      Instance.EntFireAtName({
        name: 'Map_Chunk_CaseNotShuffle2',
        input: 'AddOutput',
        value:
          'OnCase11>Preset_Maker_M*>KeyValue>EntityTemplate Temp_Chunk_11>0>-1',
      })

      Instance.EntFireAtName({
        name: 'cmd',
        input: 'Command',
        value: 'sv_disable_radar 1',
      })
      Instance.EntFireAtName({
        name: 'Map_Chunk_Counter',
        input: 'SetHitMax',
        value: chunks_survival,
      })
...
Instance.OnScriptInput('SpawnSurvivalMap', () => {
  ...
  if (floor < survival_floor_max) {
    ...
    Instance.Delay(5.0).then(() => {
      StartSurvivalZmItems()
      for (let i = 0; i < SURVIVAL_CANISTER_COUNT; i++) SpawnCanister()
    })
    Instance.ServerCommand(`say >> FLOOR ${floor} <<`)
    Instance.EntFireAtName({
      name: 'Map_Floor_SurvivalMode_Relay',
      input: 'Trigger',
    })
    Instance.EntFireAtName({
      name: 'Map_FogController_Floor3',
      input: 'Trigger',
    })
    Instance.EntFireAtName({
      name: SCRIPT_ENT,
    ...
    if (floor > 1) {
      Instance.EntFireAtName({
        name: 'Map_SurvivalMode_Cage_Teleport',
        input: 'Disable',
      })
      Instance.EntFireAtName({ name: 'Map_Chunk_Branch', input: 'Toggle' })
      Instance.EntFireAtName({
        name: 'Map_Store_Branch',
        input: 'SetValue',
        value: '1',
      })
      Instance.EntFireAtName({
        name: 'Map_Store_BranchChat',
        input: 'SetValue',
        value: '0',
      })
      Instance.EntFireAtName({
    ...
    SetFloor('')
    Instance.EntFireAtName({
      name: 'Map_SurvivalMode_Spawn_Teleport',
      input: 'Disable',
    })
    Instance.EntFireAtName({ name: 'Map_Spawn_Teleport', input: 'Enable' })
    Instance.EntFireAtName({
      name: 'Template_ElevatorTeleport',
      input: 'KeyValue',
      value: 'origin 7504 -11264 -12984',
      delay: 0.0,
    })
    Instance.EntFireAtName({
      name: 'Template_ElevatorTeleport',
    ...
    Instance.EntFireAtName({
      name: 'Map_Floor_TeleportToEnd',
      input: 'AddOutput',
      value: 'OnStartTouch>!activator>KeyValue>origin 7488 -11264 -12974>0>-1',
      delay: 0.0,
    })
    Instance.EntFireAtName({
      name: 'Map_Floor_TeleportToEnd',
      input: 'AddOutput',
      value: 'OnStartTouch>!activator>KeyValue>angles 0 0 0>0>-1',
      delay: 0.0,
    })
  }
})
...
Instance.OnScriptInput('SpawnCommonMap', () => {
  ...
  if (floor <= floors_max - 1 && !isMiniBossFight) {
    ...
    if (floor >= floors_min && floor <= floors_max) {
      ...
      if (floor > 3) {
        ...
        Instance.EntFireAtName({
          ...
          input: 'Command',
          value:
            'say >> Zombie Cage will open in ' + safezone_timer + ' seconds <<',
          delay: 13.0,
        })
      }
      SetFloor(`FLOOR ${floor}`)
      Instance.EntFireAtName({
        name: 'Admin_DoorTrigger',
        input: 'Enable',
        delay: 13.0,
      })
      Instance.EntFireAtName({
        name: SCRIPT_ENT,
        input: 'RunScriptInput',
        value: 'RemoveFrictionAll',
        delay: 1.0,
      })
      Instance.EntFireAtName({
        name: 'Map_Floor_Relay',
        input: 'Trigger',
        value: '',
        delay: 0.0,
      })
      Instance.EntFireAtName({
        name: 'cmd',
        input: 'Command',
        value: `say >> FLOOR ${floor} <<`,
        delay: 0.0,
      })
      Instance.EntFireAtName({
        name: `Map_FogController_Floor${floor}`,
        input: 'Trigger',
        value: '',
        delay: 0.0,
      })
      Instance.EntFireAtName({
        name: 'Map_Music_Param',
        input: 'SetFloatValue',
        value: '1.7',
        delay: 0.0,
      })
      Instance.EntFireAtName({
        name: 'Map_Music_Param2',
        input: 'SetFloatValue',
        value: '1.0',
        delay: 0.0,
      })
      Instance.EntFireAtName({
        name: 'Map_Chunk_Add_Case',
        input: 'InValue',
        value: floor,
        delay: 0.0,
      })
      Instance.EntFireAtName({
        name: 'Map_Human_Item_Case',
        input: 'InValue',
        value: floor,
        delay: 16.0,
      })
      Instance.EntFireAtName({
        name: 'Map_Floor_SafeZone_Doors',
        input: 'Open',
        value: '',
        delay: 13.0 + safezone_timer,
      })
      Instance.EntFireAtName({
        name: 'Map_Floor_SafeZone_BreakableDoor_Case',
        input: 'PickRandomShuffle',
        value: '',
        delay: 12.0 + safezone_timer,
      })
      Instance.EntFireAtName({
        name: 'Map_Floor_SafeZone_BreakableDoor_Case',
        input: 'PickRandomShuffle',
        value: '',
        delay: 14.0 + safezone_timer,
      })
      Instance.EntFireAtName({
        name: 'Map_Floor_SafeZone_BreakableDoor_Case',
        input: 'PickRandomShuffle',
        value: '',
        delay: 16.0 + safezone_timer,
      })
      Instance.EntFireAtName({
        name: 'Map_Items_Toggle',
        input: 'FireUser2',
        value: '',
        delay: 13.0 + safezone_timer,
      })
      Instance.EntFireAtName({
        name: 'Map_Items_Ammunition',
        input: 'Trigger',
        value: '',
        delay: 13.0 + safezone_timer,
      })
    ...
    if (floor == 1 && isVipMode) {
      ...
      player_text?.Teleport({
        position: {
          x: player_origin.x,
          y: player_origin.y,
          z: player_origin.z + 80,
        },
      })
      ...
      Instance.EntFireAtName({
        name: 'cmd',
        input: 'Command',
        value: `say >> VIP是 ${player_name}! 别把这个人卖了! <<`,
        delay: 15.0,
      })
      Instance.EntFireAtTarget({
        target: VIP_PLAYER,
    ...
    if (event_item?.value == 1) {
      ...
      Instance.EntFireAtName({
        name: 'Map_Floor_Rain_Particle',
        input: 'DestroyImmediately',
        delay: 13.02,
      })
      Instance.EntFireAtName({
        name: 'Map_Floor_Snow_Particle',
        input: 'Start',
        value: '',
        delay: 13.0,
      })
      Instance.EntFireAtName({
        name: 'Map_Floor_Freeze_Postprocessing',
        input: 'Enable',
        value: '',
        delay: 9.0,
      })
    ...
    if (event_item?.value == 2) {
      ...
      Instance.EntFireAtName({
        name: 'Map_Floor_Fire_Postprocessing',
        input: 'Enable',
        value: '',
        delay: 9.0,
      })
      Instance.EntFireAtName({
        name: 'Map_Extinguisher_Case',
        input: 'PickRandomShuffle',
        delay: 9.0,
      })
      Instance.EntFireAtName({
    ...
    if (event_item?.value == 3) {
      ...
      Instance.EntFireAtName({
        name: 'Map_Floor_BlackWhite_Postprocessing',
        input: 'Enable',
        value: '',
        delay: 9.0,
      })
      Instance.EntFireAtName({
        name: 'Map_Noise_Effect',
        input: 'Start',
        value: '',
        delay: 15.0,
      })
    ...
    if (floor == 1 && !isExtremeMode) {
      Instance.EntFireAtName({
        name: 'Item_Trail_Orange_Template',
        input: 'KeyValue',
        value: 'origin 310 308 13400',
        delay: 5.0,
      })
      Instance.EntFireAtName({
        name: 'Item_Trail_Orange_Template',
    ...
    if (floor == 2 && !isExtremeMode) {
      Instance.EntFireAtName({
        name: 'Item_Trail_Green_Template',
        input: 'KeyValue',
        value: 'origin 310 308 13400',
        delay: 5.0,
      })
    ...
    if (isLightningStrikes) {
      if (!isExtremeMode) {
        if (floor == Math.floor((floors_max - 1) * 0.8)) {
          Instance.EntFireAtName({
            name: 'Map_Floor_Lightning_Strike_Case',
            input: 'PickRandomShuffle',
            value: '',
            delay: 13.0,
          })
        ...
        if (floor == floors_max - 1) {
          ...
          Instance.EntFireAtName({
            name: 'Map_Floor_CheckTeleported',
            input: 'Trigger',
            value: '',
            delay: 13.0,
          })
          Instance.EntFireAtName({
            name: 'Map_WeatherEvent_Relay',
            input: 'Trigger',
            value: '',
            delay: 13.0,
          })
    ...
    if (floor == 1 || floor == 3 || floor == 5) {
      Instance.EntFireAtName({
        name: 'Map_ZM_Item_Maker5',
        input: 'ForceSpawn',
        value: '',
        delay: 3.5,
      }) // ADDITIONAL ITEM (only 1, 3 and 5 FLOORS)
    }
    if (floor > 1) {
      Instance.EntFireAtName({
        name: 'Map_ZM_Item_Case',
        input: 'ResetShuffle',
        value: '',
        delay: 0.0,
      })
  ...
  if (floor == floors_max) {
    ...
    if (meat < meat_max) {
      ...
      Instance.EntFireAtName({
        ...
        input: 'AddOutput',
        value:
          'OnStartTouch>!activator>KeyValue>origin 7488 -11264 -12974>0>-1',
        delay: 0.0,
      })
      Instance.EntFireAtName({
        name: 'Map_Floor_TeleportToEnd',
    ...
    if (meat >= meat_max) {
      ...
      Instance.EntFireAtName({
        name: 'Map_QuestionableEnding_Relay',
        input: 'Trigger',
        value: '',
        delay: 0.0,
      })
      Instance.EntFireAtName({
        name: 'Map_Floor_TeleportToEnd',
        input: 'AddOutput',
        value: 'OnStartTouch>Map_Boss_Arena_ZM_Case>PickRandomShuffle>>0>-1',
        delay: 0.0,
      })
    }
  }
...
Instance.OnScriptInput('WormBossRelay', () => {
  ...
  Instance.EntFireAtName({
    name: 'Template_ElevatorTeleport',
    input: 'KeyValue',
    value: 'origin 10592 0 -15368',
  })
  Instance.EntFireAtName({
    name: 'Template_ElevatorTeleport',
    input: 'KeyValue',
    value: 'angles 0 180 0',
  })
  Instance.EntFireAtName({
    name: 'Template_ElevatorTeleport',
    input: 'ForceSpawn',
  ...
  Instance.EntFireAtName({
    name: 'MiniBoss_Worm_Elevator_Move',
    input: 'FireUser1',
    value: '',
    delay: 6.6,
  })
  ...
  Instance.EntFireAtName({
    name: 'cmd',
    input: 'Command',
    value: `say >> #CONNECTION_LOST <<`,
    delay: 1.0,
  })
  Instance.EntFireAtName({
    name: 'Map_Floor_TeleportToMiniBoss',
    input: 'Enable',
    value: '',
    delay: 2.0,
  })
  ...
  Instance.EntFireAtName({
    name: 'Map_Chunk_Backrooms_Music*',
    input: 'StopSound',
    value: '',
    delay: 0.0,
  })
  ...
  Instance.EntFireAtName({
    name: 'Map_Chunk_TwinPeaks_Music*',
    input: 'StopSound',
    value: '',
    delay: 0.0,
  })
  ...
  Instance.EntFireAtName({
    name: 'Map_Chunk_SilentHill3_Music*',
    input: 'StopSound',
    value: '',
    delay: 0.0,
  })
...
Instance.OnScriptInput('WormPartInit', () => {
  WormPartInit()
})
function WormPartInit() {
  const WORM_PARTS_NAME = [
    'Worm_Face_Train',
    'Worm_Top_Train',
    'Worm_Middle_Train',
    'Worm_Small_Train',
  ...
  const startID = NAVMESH_GetNearestNavPoint({
    x: 12556,
    y: 81.851509,
    z: -15223,
  })
  ...
  vecOrigin = {
    x: vecOrigin.x,
    y: vecOrigin.y,
    z: vecOrigin.z - (128 + 128 * WORM_PARTS.length),
  }
...
Instance.OnScriptInput('WormStart', () => {
  ...
  Instance.EntFireAtName({
    name: 'Map_BossWorm_HP_Particle',
    input: 'FireUser1',
  })
  Instance.EntFireAtName({
    name: 'Map_BossWorm_Music',
    input: 'StartSound',
    value: '',
    delay: 1.5,
  })
  Instance.EntFireAtName({
    name: 'Map_UI_MotherOfConcrete',
    input: 'Start',
    value: '',
    delay: 1.5,
  })
...
Instance.OnScriptInput('WormDie', () => {
  ...
  if (meat_random > 1) {
    Instance.EntFireAtName({
      name: 'Worm_Face_MineMaker',
      input: 'KeyValue',
      value: 'EntityTemplate Item_Meat_Template',
      delay: 0.02,
    })
    Instance.EntFireAtName({
      name: 'Worm_Face_MineMaker',
  ...
  Instance.EntFireAtName({ name: 'worm_train_*', input: 'Kill', delay: 0.1 })
  Instance.EntFireAtName({ name: 'worm_face_*', input: 'Kill', delay: 0.1 })
  Instance.EntFireAtName({ name: 'worm_top_*', input: 'Kill', delay: 0.1 })
  Instance.EntFireAtName({ name: 'worm_middle_*', input: 'Kill', delay: 0.1 })
  Instance.EntFireAtName({ name: 'worm_small_*', input: 'Kill', delay: 0.1 })
  Instance.EntFireAtName({ name: 'worm_end_*', input: 'Kill', delay: 0.1 })
  Instance.EntFireAtName({
    name: 'Worm_Face_ShakeTimer*',
    input: 'Kill',
    delay: 0.05,
  })
  Instance.EntFireAtName({
    name: 'Item_Mine_Button*',
    input: 'Kill',
    delay: 0.05,
  })
  Instance.EntFireAtName({
    name: 'Item_Mine_Maker*',
    input: 'Kill',
    delay: 0.05,
  })
  Instance.EntFireAtName({
    name: 'Item_Mine_Model*',
    input: 'Kill',
    delay: 0.05,
  })
  Instance.EntFireAtName({
    name: 'Item_Mine_Filter*',
    input: 'Kill',
    delay: 0.05,
  })
  Instance.EntFireAtName({
    name: 'Item_Mine_Weapon*',
    input: 'FireUser4',
    delay: 0.05,
  })
  Instance.EntFireAtName({
  ...
  Instance.EntFireAtName({
    name: 'Map_BossWorm_ZombiesSpeed_Trigger',
    input: 'Kill',
  })
  Instance.EntFireAtName({
    name: 'Map_BossWorm_LightningStrike_Detect',
    input: 'Kill',
  })
  Instance.EntFireAtName({
    name: SCRIPT_ENT,
  ...
  Instance.EntFireAtName({
    name: 'ElevatorTeleport_In_Button*',
    input: 'Unlock',
    value: '',
    delay: 0.0,
  })
  Instance.EntFireAtName({
    name: 'Map_BossWorm_Elevator_Hurt',
    input: 'Kill',
    value: '',
    delay: 0.0,
  })
  Instance.EntFireAtName({
    name: 'ElevatorTeleport_Mouth_Sound_Yummy*',
    input: 'Kill',
    value: '',
    delay: 0.0,
  })
  Instance.EntFireAtName({
    name: 'ElevatorTeleport_In_Button*',
    input: 'AddOutput',
    value: 'OnPressed>Map_BossWorm_Elevator_Relay>Trigger>>0>1',
    delay: 0.0,
  })
  Instance.EntFireAtName({
    name: 'ElevatorTeleport_In_Button*',
    input: 'AddOutput',
    value: 'OnPressed>!self>Lock>>0>1',
    delay: 0.0,
  })
  Instance.EntFireAtName({
    name: 'ElevatorTeleport_In_Button*',
  ...
  Instance.EntFireAtName({
    name: 'MiniBoss_Worm_Elevator_Door_Outside',
    input: 'Open',
    value: '',
    delay: 2.0,
  })
  Instance.EntFireAtName({
    name: 'MiniBoss_Worm_Elevator_Door_Inside',
    input: 'Open',
    value: '',
    delay: 2.0,
  })
...
Instance.OnScriptInput('WormTick', () => {
  if (!WORM_DEAD) {
    ...
    let n_Origin = Vector3Utils.add(
      me_Origin,
      Vector3Utils.scale(EulerUtils.forward(target_Angles), WORM_PART_DISTANCE),
    )
    let deltaTime = 0.016
    ...
    for (let i = WORM_PARTS.length - 1; i > 0; i--) {
      ...
      WORM_PARTS[i].Teleport({
        position: newPos,
        angles: WORM_PARTS[i - 1].GetAbsAngles(),
      })
...
function GetValidPlayersCT() {
  return Instance.FindEntitiesByClass('player').filter((p) =>
    IsValidPlayerTeam(p, 3),
  )
}

function GetValidPlayersT() {
  return Instance.FindEntitiesByClass('player').filter((p) =>
    IsValidPlayerTeam(p, 2),
  )
}
...
function ClearPlayerHudState(slot) {
  ...
  for (const card of SKIN_CARDS) {
    ...
    HUD_ENT.SetDialogVariableStringForPlayer(
      slot,
      'skin_state_' + card.key,
      'txt',
      '',
    )
  }
  ...
  for (const team of ['ct', 't']) {
    for (let i = 0; i < RADAR_DOTS_PER_TEAM; i++) {
      HUD_ENT.SetHasClassForPlayer(
        slot,
        'radar_cell_highlight_' + team + '_' + i,
        'Visible',
      )
    }
  }
...
function ResetFloor() {
  ...
  Instance.EntFireAtName({
    name: SCRIPT_ENT,
    input: 'RunScriptInput',
    value: 'SamosborHurtStop',
    delay: 0.0,
  })
  Instance.EntFireAtName({
    name: SCRIPT_ENT,
    input: 'RunScriptInput',
    value: 'SamosborBoolsEnableBack',
    delay: 3.0,
  })
  store_item_prices = {}
...
function ResetScript() {
  ...
  Temp_Item_Flamethrower = Instance.FindEntityByName(
    'Item_Flamethrower_Template',
  )
  Temp_Item_SuicideBomber = Instance.FindEntityByName(
    'Item_SuicideBomber_Template',
  )
...
function ResetAdminWorldText() {
  ...
  Instance.EntFireAtName({
    name: 'Admin_Traps_Value',
    input: 'SetMessage',
    value: traps_percentage + '%',
    delay: 0.0,
  })
  Instance.EntFireAtName({
    name: 'Admin_NPCs_Value',
    input: 'SetMessage',
    value: npcs_percentage + '%',
    delay: 0.0,
  })
  if (isExitGlow) {
    Instance.EntFireAtName({
  ...
  Instance.EntFireAtName({
    name: 'Admin_SamosborTime_Value',
    input: 'SetMessage',
    value: `${samosbortime / 60} Minute(s)`,
    delay: 0.0,
  })
  Instance.EntFireAtName({
    name: 'Admin_SamosborDamage_Value',
    input: 'SetMessage',
    value: samosbordamage,
    delay: 0.0,
  })
}
...
function UpdateRadarDots() {
  ...
  UpdateRadarTeamDots(
    ...
    GetValidPlayersCT(),
    'radar_dot_ct',
    'radar_cell_highlight_ct',
  )
  UpdateRadarTeamDots(
    't',
    GetValidPlayersT(),
    'radar_dot_t',
    'radar_cell_highlight_t',
  )
  ...
  for (const [slot, inst] of PlayerInstancesMap) {
    ...
    const newId =
      playerIndex >= 0
        ? 'radar_cell_highlight_' + teamKey + '_' + playerIndex
        : null
...
function ToggleRadar(slot, inst, player) {
  ...
  HUD_ENT.SetHasClassForPlayer(
    ...
    'radar_dots_ct',
    'Visible',
    inst.HudRadarOpen && team === 3,
  )
  HUD_ENT.SetHasClassForPlayer(
    slot,
    'radar_dots_t',
    'Visible',
    inst.HudRadarOpen && team === 2,
  )
}
...
function UpdateUseProgress(slot, inst, player, now) {
  ...
  if (now - inst.SpannerUseStartTime >= inst.SpannerUseDuration) {
    ...
    const trapType = TRAP_TYPES.find(
      (t) => trapName && trapName.includes(t.name),
    )
...
function RefreshModeTexts() {
  ...
  else if (revealingWinner)
    status = 'SETTING MODE TO ' + MODE_DEFS[activeModeIndex].name
...
function RefreshSkinMenu(slot, inst) {
  ...
  HUD_ENT.SetDialogVariableStringForPlayer(
    ...
    'txt',
    any
      ? 'Click a skin to apply it.'
      : 'Skins are available to players with a flag.',
  )
}
...
function HandleAdminClick(buttonId, inst) {
  ...
  for (const item of ADMIN_NUMERIC) {
    for (const s of item.steps) {
      if (buttonId === 'admin_' + item.key + '_sub' + s) {
        item.fn()(s)
        UpdateAdminValues()
        return true
      }
      if (buttonId === 'admin_' + item.key + '_add' + s) {
        item.fn()('-' + s)
        UpdateAdminValues()
        return true
      }
  ...
  for (const item of ADMIN_TOGGLES) {
    if (buttonId === 'admin_' + item.key + '_off') {
      item.fn()('0')
      UpdateAdminValues()
      return true
    }
    if (buttonId === 'admin_' + item.key + '_on') {
      item.fn()('1')
      UpdateAdminValues()
      return true
    }
...
function LoadStats() {
  ...
  if (!Array.isArray(STATS.ways) || STATS.ways.length !== 4)
    STATS.ways = [0, 0, 0, 0]
...
function CountBottle(n) {
  STATS.totals.bottles += n || 1
}
function CountBottleSpent(n) {
  STATS.totals.bottles_spent += n || 1
}
function CountSpin() {
  STATS.totals.spins++
}
...
function RefreshMapStats() {
  ...
  HUD_ENT.SetDialogVariableString(
    'ms_rec_en2',
    'val',
    FormatRecord(STATS.records.easy_normal),
  )
  HUD_ENT.SetDialogVariableString(
    'ms_rec_et2',
    'val',
    FormatRecord(STATS.records.easy_true),
  )
  HUD_ENT.SetDialogVariableString(
    'ms_rec_nn',
    'val',
    FormatRecord(STATS.records.normal_normal),
  )
  HUD_ENT.SetDialogVariableString(
    'ms_rec_nt',
    'val',
    FormatRecord(STATS.records.normal_true),
  )
  HUD_ENT.SetDialogVariableString(
    'ms_rec_en',
    'val',
    FormatRecord(STATS.records.extreme_normal),
  )
  HUD_ENT.SetDialogVariableString(
    'ms_rec_et',
    'val',
    FormatRecord(STATS.records.extreme_true),
  )
  ...
  HUD_ENT.SetDialogVariableString(
    'ms_floors',
    'val',
    String(STATS.totals.floors),
  )
  HUD_ENT.SetDialogVariableString('ms_traps', 'val', String(STATS.totals.traps))
  HUD_ENT.SetDialogVariableString(
    'ms_bottles',
    'val',
    String(STATS.totals.bottles),
  )
  HUD_ENT.SetDialogVariableString(
    'ms_bottles_spent',
    'val',
    String(STATS.totals.bottles_spent),
  )
...
function SurvivalDestinationTick() {
  ...
  for (const dest of SURVIVAL_DESTINATIONS) {
    ...
    for (const human of humans) {
      ...
      if (
        VectorDistance(dest.position, human.GetAbsOrigin()) <
        SURVIVAL_DEST_SAFE_RADIUS
      ) {
        dest.blocked = true
        break
      }
...
function GetDestinationsAndRemove() {
  ...
  Instance.Msg(
    'GetDestinationsAndRemove: добавлено ' +
      added +
      ', всего ' +
      SURVIVAL_DESTINATIONS.length,
  )
}
...
Instance.OnScriptInput(
  ...
  ({ caller, activator }) => {
    ...
    const humans = GetValidPlayersCT().filter(
      (h) => h?.IsValid() && h?.IsAlive(),
    )
    ...
    if (humans.length === 0) {
      dest =
        SURVIVAL_DESTINATIONS[
          GetRandomNumber(0, SURVIVAL_DESTINATIONS.length - 1)
        ]
    } else {
  ...
  for (const ent of spawned ?? []) {
    ...
    if (cls === 'weapon_elite') {
      Instance.EntFireAtTarget({
        target: ent,
        input: 'AddOutput',
        value: 'OnPlayerPickup>!self>FireUser1>>0>1',
      })
    }
  }
...
function SpawnZmItemNearZombies() {
  ...
  if (zombies.length === 0) {
    ...
    const target =
      zombies[GetRandomNumber(0, zombies.length - 1)].GetAbsOrigin()
