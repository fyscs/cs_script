...
function handleLastManStanding() {
    ...
    utils.EntFire("_human_item_tank_health_drivver_zombiekill","Enable","",0.02);
    utils.EntFire("_human_item_tank_health_drivver_zombiekill","Trigger","",0.04);
    utils.EntFire("v_model1","Fireuser3","",0.06);
    utils.EntFire("Human_Item_Mech_UI","Deactivate","",0.02);
    utils.EntFire("Human_Item_Mech_Cam","DisableCamera","",0.02);
    utils.EntFire("Human_Item_Mech_Attack_*","Kill","",0.04);
    utils.EntFire("Human_Item_Mech_Hurt_*","Kill","",0.04);
    utils.EntFire("Human_Item_Mech_Model","SetAnimation","Die",0.04);
    ...
    utils.EntFire("Human_Item_Mech_Body","Break",0.1);
    utils.EntFire("Human_Item_Mech*","Kill","",2.50);
    ...
    utils.EntFire("teleport_lastmanstanding","Enable","",0.50);
    utils.EntFire("lms_fuckoffzombies","Disable","",0.60);
    utils.EntFire("teleport_lastmanstanding","Disable","",0.60);
