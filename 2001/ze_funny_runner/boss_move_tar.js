...
const SPEED_FORWARD = 400;
const RETARGET_TIME = 5.00;

const boss_model = "funny_virus";
const boss_move_physbox = "Move_Physbox";
const boss_script_ent = "boss_script";
...
// {
//     let selfEnt = Instance.GetSelf(); 
//     boss_script_ent = selfEnt.GetName();

//      if (boss_script_ent.includes("_script"))
//     {
//         boss_tag = boss_script_ent.replace("_script", "");
//     } 
//     else 
//     {
//         boss_tag = boss_script_ent;
//     }

//     Instance.Msg("Boss Script ID = " + boss_id);

//     let models = Instance.FindEntitiesByClass("prop_dynamic")
//         .filter(ent => ent.GetName().endsWith("_" + boss_id));

//     if (models.length > 0) {
//         bmdl = models[0];
//         Instance.Msg("Find boss model: " + bmdl.GetName());
//     } else {
//         Instance.Msg("Not found boss model ID " + boss_id);
//     }

//     let phys = Instance.FindEntitiesByClass("func_physbox")
//         .filter(ent => ent.GetName().endsWith("_" + boss_id));

//     if (phys.length > 0) {
//         bmphy = phys[0];
//         Instance.Msg(" Find boss phys: " + bmphy.GetName());
//     } else {
//         Instance.Msg("Not found boss phys ID " + boss_id);
//     }
// }
