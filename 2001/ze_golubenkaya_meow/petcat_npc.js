...
const npc_name = "petcat_hbox*";
const NPC_MAKER = "petcat_add_temp";
const boss_script = "petcat_npc_script";
let NPC_ENT = null;
let NPC_ENTS_ASPAWN = null;
let IGNORE_BOSS = [];

const BOSS_ENTITIES_MAP = {
    "petcat_hbox": "SetBossPhysBoxEnt",
    "petcat_phys": "SetBossTrainEnt",
    "petcat_npc_path_01": "SetBossFirstPathEnt",
    "petcat_npc_path_02": "SetBossSecPathEnt",
    "petcat_model": "SetBossModelEnt",
};
