...
{ q:"In Spades, the goal is to?", correct:"Meet your bid in tricks", wrong:["Avoid all tricks","Collect only spades"] },
  { id:"cartoons_001", topic:"cartoons", text:"In *Avatar: The Last Airbender*, what is the name of Aang’s original sky bison?", answers:["Appa","Momo","Naga"], correct:0 },
  { id:"cartoons_002", topic:"cartoons", text:"In *Avatar: The Last Airbender*, what is the name of Aang’s lemur companion?", answers:["Momo","Appa","Pabu"], correct:0 },
  { id:"cartoons_003", topic:"cartoons", text:"In *Avatar: The Last Airbender*, which city is the Earth Kingdom capital?", answers:["Ba Sing Se","Omashu","Zaofu"], correct:0 },
  { id:"cartoons_004", topic:"cartoons", text:"In *Avatar: The Last Airbender*, who leads the Kyoshi Warriors first seen in the series?", answers:["Suki","Ty Lee","Mai"], correct:0 },
  { id:"cartoons_005", topic:"cartoons", text:"In *Avatar: The Last Airbender*, what is Iroh’s nickname among some?", answers:["Dragon of the West","Phoenix King","Blue Spirit"], correct:0 },

  { id:"cartoons_006", topic:"cartoons", text:"In *Adventure Time*, what is the name of Finn’s magical dog brother?", answers:["Jake","BMO","Ice King"], correct:0 },
  { id:"cartoons_007", topic:"cartoons", text:"In *Adventure Time*, what kingdom does Princess Bubblegum rule?", answers:["Candy Kingdom","Ice Kingdom","Fire Kingdom"], correct:0 },
  { id:"cartoons_008", topic:"cartoons", text:"In *Adventure Time*, what is the Ice King’s real name?", answers:["Simon Petrikov","Evergreen","Gunter"], correct:0 },
  { id:"cartoons_009", topic:"cartoons", text:"In *Adventure Time*, which character is a small, living game console?", answers:["BMO","NEPTR","Shelby"], correct:0 },
  { id:"cartoons_010", topic:"cartoons", text:"In *Adventure Time*, what is the name of Marceline’s bass axe?", answers:["Axe Bass","Night Bass","Demon Chord"], correct:0 },

  { id:"cartoons_011", topic:"cartoons", text:"In *Gravity Falls*, what is Dipper’s real first name?", answers:["Mason","Dipper","Stanley"], correct:0 },
  { id:"cartoons_012", topic:"cartoons", text:"In *Gravity Falls*, what is Mabel’s pig named?", answers:["Waddles","Puddles","Snuffles"], correct:0 },
  { id:"cartoons_013", topic:"cartoons", text:"In *Gravity Falls*, who is the one-eyed dream demon?", answers:["Bill Cipher","The Axolotl","Gideon Gleeful"], correct:0 },
  { id:"cartoons_014", topic:"cartoons", text:"In *Gravity Falls*, what is the name of the tourist trap where the Pines work?", answers:["Mystery Shack","Oddity Hut","Curiosity Cabin"], correct:0 },
  { id:"cartoons_015", topic:"cartoons", text:"In *Gravity Falls*, which journal number does Dipper first find?", answers:["Journal 3","Journal 1","Journal 2"], correct:0 },

  { id:"cartoons_016", topic:"cartoons", text:"In *Steven Universe*, what gemstone is Garnet a fusion of?", answers:["Ruby and Sapphire","Pearl and Amethyst","Jasper and Lapis"], correct:0 },
  { id:"cartoons_017", topic:"cartoons", text:"In *Steven Universe*, what is the name of Steven’s hometown?", answers:["Beach City","Ocean Town","Coast Bay"], correct:0 },
  { id:"cartoons_018", topic:"cartoons", text:"In *Steven Universe*, which Gem is known for shapeshifting and a whip weapon?", answers:["Amethyst","Pearl","Peridot"], correct:0 },
  { id:"cartoons_019", topic:"cartoons", text:"In *Steven Universe*, what is Pearl’s weapon?", answers:["Spear","Hammer","Scythe"], correct:0 },
  { id:"cartoons_020", topic:"cartoons", text:"In *Steven Universe*, what is the name of Steven’s father?", answers:["Greg Universe","Marty Universe","Andy Universe"], correct:0 },

  { id:"cartoons_021", topic:"cartoons", text:"In *The Simpsons*, what is the name of the Simpsons’ hometown?", answers:["Springfield","Shelbyville","Ogdenville"], correct:0 },
  { id:"cartoons_022", topic:"cartoons", text:"In *The Simpsons*, what is Homer’s middle initial?", answers:["J","D","B"], correct:0 },
  { id:"cartoons_023", topic:"cartoons", text:"In *The Simpsons*, what is the name of Mr. Burns’ assistant?", answers:["Waylon Smithers","Lenny Leonard","Carl Carlson"], correct:0 },
  { id:"cartoons_024", topic:"cartoons", text:"In *The Simpsons*, what instrument does Lisa play?", answers:["Saxophone","Clarinet","Trumpet"], correct:0 },
  { id:"cartoons_025", topic:"cartoons", text:"In *The Simpsons*, what is the name of the bar Homer frequents?", answers:["Moe’s Tavern","The Rusty Anchor","Duff House"], correct:0 },

  { id:"cartoons_026", topic:"cartoons", text:"In *Futurama*, what is Fry’s first name?", answers:["Philip","Hubert","Zapp"], correct:0 },
  { id:"cartoons_027", topic:"cartoons", text:"In *Futurama*, what is Leela’s full name?", answers:["Turanga Leela","Leela Turanga","Leela Nibbler"], correct:0 },
  { id:"cartoons_028", topic:"cartoons", text:"In *Futurama*, what is Bender’s full designation?", answers:["Bender Bending Rodríguez","Bender Unit-9","Bender Steelson"], correct:0 },
  { id:"cartoons_029", topic:"cartoons", text:"In *Futurama*, what is the Planet Express ship’s nickname?", answers:["The Planet Express Ship","The Nimbus","The Starbug"], correct:0 },
  { id:"cartoons_030", topic:"cartoons", text:"In *Futurama*, who is the elderly professor and founder of Planet Express?", answers:["Professor Farnsworth","Professor Frink","Professor X"], correct:0 },

  { id:"cartoons_031", topic:"cartoons", text:"In *Rick and Morty*, what is Morty’s last name?", answers:["Smith","Sanchez","Johnson"], correct:0 },
  { id:"cartoons_032", topic:"cartoons", text:"In *Rick and Morty*, what is Rick’s last name?", answers:["Sanchez","Smith","Wong"], correct:0 },
  { id:"cartoons_033", topic:"cartoons", text:"In *Rick and Morty*, what is the name of the family’s father?", answers:["Jerry","Summer","Beth"], correct:0 },
  { id:"cartoons_034", topic:"cartoons", text:"In *Rick and Morty*, what is the name of the family’s mother?", answers:["Beth","Diane","Tammy"], correct:0 },
  { id:"cartoons_035", topic:"cartoons", text:"In *Rick and Morty*, which agency is often shown opposing Rick?", answers:["Galactic Federation","U.N.I.T.","S.H.I.E.L.D."], correct:0 },

  { id:"cartoons_036", topic:"cartoons", text:"In *Archer*, what is the spy agency’s name in early seasons?", answers:["ISIS","MI6","CIA"], correct:0 },
  { id:"cartoons_037", topic:"cartoons", text:"In *Archer*, what is Archer’s first name?", answers:["Sterling","Cyril","Ray"], correct:0 },
  { id:"cartoons_038", topic:"cartoons", text:"In *Archer*, what is Malory Archer’s relationship to Sterling?", answers:["Mother","Aunt","Sister"], correct:0 },
  { id:"cartoons_039", topic:"cartoons", text:"In *Archer*, what is the name of Archer’s on-again off-again partner?", answers:["Lana Kane","Pam Poovey","Cheryl Tunt"], correct:0 },
  { id:"cartoons_040", topic:"cartoons", text:"In *Archer*, what is Cyril Figgis’ typical role?", answers:["Accountant/agent","Pilot","Medic"], correct:0 },

  { id:"cartoons_041", topic:"cartoons", text:"In *Batman: The Animated Series*, who voices Batman most famously?", answers:["Kevin Conroy","Mark Hamill","Bruce Timm"], correct:0 },
  { id:"cartoons_042", topic:"cartoons", text:"In *Batman: The Animated Series*, who voices the Joker most famously?", answers:["Mark Hamill","Kevin Conroy","Clancy Brown"], correct:0 },
  { id:"cartoons_043", topic:"cartoons", text:"In *Batman: The Animated Series*, what is Harley Quinn’s real first name?", answers:["Harleen","Helena","Hazel"], correct:0 },
  { id:"cartoons_044", topic:"cartoons", text:"In *Justice League Unlimited*, what is the name of the Martian hero?", answers:["J'onn J'onzz","Kara Zor-El","John Stewart"], correct:0 },
  { id:"cartoons_045", topic:"cartoons", text:"In *Justice League* (animated), which Lantern is a main team member?", answers:["John Stewart","Hal Jordan","Kyle Rayner"], correct:0 },

  { id:"cartoons_046", topic:"cartoons", text:"In *Teen Titans* (2003), what is Raven’s father?", answers:["Trigon","Darkseid","Slade"], correct:0 },
  { id:"cartoons_047", topic:"cartoons", text:"In *Teen Titans* (2003), what is Beast Boy’s real name?", answers:["Garfield Logan","Victor Stone","Dick Grayson"], correct:0 },
  { id:"cartoons_048", topic:"cartoons", text:"In *Teen Titans* (2003), what is Cyborg’s real name?", answers:["Victor Stone","Wally West","Roy Harper"], correct:0 },
  { id:"cartoons_049", topic:"cartoons", text:"In *Teen Titans* (2003), who is the masked main antagonist often called?", answers:["Slade","Bane","Riddler"], correct:0 },
  { id:"cartoons_050", topic:"cartoons", text:"In *Teen Titans* (2003), Starfire’s home planet is?", answers:["Tamaran","Krypton","Thanagar"], correct:0 },

  { id:"cartoons_051", topic:"cartoons", text:"In *The Powerpuff Girls*, the city they protect is?", answers:["Townsville","Metro City","Springfield"], correct:0 },
  { id:"cartoons_052", topic:"cartoons", text:"In *The Powerpuff Girls*, the girls were created using?", answers:["Chemical X","Element X","Compound Z"], correct:0 },
  { id:"cartoons_053", topic:"cartoons", text:"In *The Powerpuff Girls*, the mayor’s assistant/secretary is named?", answers:["Ms. Bellum","Ms. Keane","Ms. Sara"], correct:0 },
  { id:"cartoons_054", topic:"cartoons", text:"In *The Powerpuff Girls*, the girls’ creator is?", answers:["Professor Utonium","Professor Farnsworth","Dr. Doofenshmirtz"], correct:0 },
  { id:"cartoons_055", topic:"cartoons", text:"In *The Powerpuff Girls*, the main villainous chimp is?", answers:["Mojo Jojo","I.M. Weasel","Mr. Bobo"], correct:0 },

  { id:"cartoons_056", topic:"cartoons", text:"In *Samurai Jack*, Jack’s main enemy is?", answers:["Aku","Oni","Ryuk"], correct:0 },
  { id:"cartoons_057", topic:"cartoons", text:"In *Dexter’s Laboratory*, Dexter’s sister is?", answers:["Dee Dee","Darla","Didius"], correct:0 },
  { id:"cartoons_058", topic:"cartoons", text:"In *Courage the Cowardly Dog*, the elderly woman is?", answers:["Muriel","Mabel","Martha"], correct:0 },
  { id:"cartoons_059", topic:"cartoons", text:"In *Courage the Cowardly Dog*, the grumpy farmer is?", answers:["Eustace","Edgar","Ernest"], correct:0 },
  { id:"cartoons_060", topic:"cartoons", text:"In *Ed, Edd n Eddy*, which character is also called “Double D”?", answers:["Edd","Ed","Eddy"], correct:0 },

  { id:"cartoons_061", topic:"cartoons", text:"In *Johnny Bravo*, Johnny’s catchphrase includes?", answers:["‘Hoo-ha!’","‘Wubba lubba dub-dub!’","‘Spoon!’"], correct:0 },
  { id:"cartoons_062", topic:"cartoons", text:"In *The Grim Adventures of Billy & Mandy*, Grim is a?", answers:["Grim Reaper","Vampire","Werewolf"], correct:0 },
  { id:"cartoons_063", topic:"cartoons", text:"In *Foster’s Home for Imaginary Friends*, the founder is?", answers:["Madame Foster","Mr. Herriman","Frankie Foster"], correct:0 },
  { id:"cartoons_064", topic:"cartoons", text:"In *Foster’s Home for Imaginary Friends*, the blue imaginary friend is?", answers:["Blooregard ‘Bloo’ Q. Kazoo","Wilt","Eduardo"], correct:0 },
  { id:"cartoons_065", topic:"cartoons", text:"In *Chowder*, Chowder is an apprentice to?", answers:["Mung Daal","Shnitzel","Endive"], correct:0 },

  { id:"cartoons_066", topic:"cartoons", text:"In *Phineas and Ferb*, who is the family pet?", answers:["Perry the Platypus","Kenny the Koala","Rufus the Mole Rat"], correct:0 },
  { id:"cartoons_067", topic:"cartoons", text:"In *Phineas and Ferb*, the villain’s full name includes?", answers:["Dr. Heinz Doofenshmirtz","Dr. Julius No","Dr. Victor Fries"], correct:0 },
  { id:"cartoons_068", topic:"cartoons", text:"In *Kim Possible*, Kim’s best friend is?", answers:["Ron Stoppable","Wade Load","Josh Mankey"], correct:0 },
  { id:"cartoons_069", topic:"cartoons", text:"In *Kim Possible*, Kim’s main villain is often?", answers:["Shego","Azula","Blackfire"], correct:0 },
  { id:"cartoons_070", topic:"cartoons", text:"In *SpongeBob SquarePants*, SpongeBob works at?", answers:["The Krusty Krab","The Chum Bucket","The Salty Spitoon"], correct:0 },

  { id:"cartoons_071", topic:"cartoons", text:"In *SpongeBob SquarePants*, Mr. Krabs’ first name is?", answers:["Eugene","Edward","Ernest"], correct:0 },
  { id:"cartoons_072", topic:"cartoons", text:"In *SpongeBob SquarePants*, Plankton’s computer wife is?", answers:["Karen","Janet","Darla"], correct:0 },
  { id:"cartoons_073", topic:"cartoons", text:"In *Fairly OddParents*, Timmy’s fairy godparents are?", answers:["Cosmo and Wanda","Chip and Dale","Phil and Lil"], correct:0 },
  { id:"cartoons_074", topic:"cartoons", text:"In *Fairly OddParents*, the rulebook governing wishes is?", answers:["Da Rules","The Code","Wish Law"], correct:0 },
  { id:"cartoons_075", topic:"cartoons", text:"In *Danny Phantom*, Danny’s ghost name is?", answers:["Danny Phantom","Dark Danny","Specter Kid"], correct:0 },

  { id:"cartoons_076", topic:"cartoons", text:"In *Ben 10* (classic), the device that lets Ben transform is?", answers:["Omnitrix","AllSpark","Chronosphere"], correct:0 },
  { id:"cartoons_077", topic:"cartoons", text:"In *Ben 10* (classic), Ben’s cousin is?", answers:["Gwen","Julie","Kai"], correct:0 },
  { id:"cartoons_078", topic:"cartoons", text:"In *Ben 10* (classic), Ben’s grandpa is?", answers:["Max","Frank","Phil"], correct:0 },
  { id:"cartoons_079", topic:"cartoons", text:"In *Scooby-Doo*, Scooby’s full name is?", answers:["Scoobert Doo","Scoobington Doo","Scoobyvan Doo"], correct:0 },
  { id:"cartoons_080", topic:"cartoons", text:"In *Scooby-Doo*, Shaggy’s real first name is?", answers:["Norville","Neville","Norman"], correct:0 },

  { id:"cartoons_081", topic:"cartoons", text:"In *Looney Tunes*, Marvin the Martian is from?", answers:["Mars","Venus","Saturn"], correct:0 },
  { id:"cartoons_082", topic:"cartoons", text:"In *Looney Tunes*, Bugs Bunny’s famous greeting begins with?", answers:["‘What’s up, doc?’","‘Eh, what’s up?’","‘Hello, nurse!’"], correct:0 },
  { id:"cartoons_083", topic:"cartoons", text:"In *Tom and Jerry*, what kind of animal is Jerry?", answers:["Mouse","Hamster","Squirrel"], correct:0 },
  { id:"cartoons_084", topic:"cartoons", text:"In *Pinky and the Brain*, Pinky and the Brain are?", answers:["Lab mice","Hamsters","Rats"], correct:0 },
  { id:"cartoons_085", topic:"cartoons", text:"In *Animaniacs*, the siblings are called the?", answers:["Warner siblings","Watterson siblings","Griffin siblings"], correct:0 },

  { id:"cartoons_086", topic:"cartoons", text:"In *The Amazing World of Gumball*, Gumball’s last name is?", answers:["Watterson","Anderson","Patterson"], correct:0 },
  { id:"cartoons_087", topic:"cartoons", text:"In *The Amazing World of Gumball*, Darwin is a?", answers:["Goldfish","Turtle","Rabbit"], correct:0 },
  { id:"cartoons_088", topic:"cartoons", text:"In *Regular Show*, the blue jay protagonist is?", answers:["Mordecai","Rigby","Benson"], correct:0 },
  { id:"cartoons_089", topic:"cartoons", text:"In *Regular Show*, Rigby is a?", answers:["Raccoon","Squirrel","Ferret"], correct:0 },
  { id:"cartoons_090", topic:"cartoons", text:"In *Regular Show*, Benson is a?", answers:["Gumball machine","Vending machine","Pachinko machine"], correct:0 },

  { id:"cartoons_091", topic:"cartoons", text:"In *The Owl House*, the main witch-in-training is?", answers:["Luz Noceda","Amity Blight","Willow Park"], correct:0 },
  { id:"cartoons_092", topic:"cartoons", text:"In *The Owl House*, the tiny demon companion is?", answers:["King","Hooty","Eda"], correct:0 },
  { id:"cartoons_093", topic:"cartoons", text:"In *The Owl House*, Eda’s nickname is?", answers:["The Owl Lady","The Cat Witch","The Raven Queen"], correct:0 },
  { id:"cartoons_094", topic:"cartoons", text:"In *Amphibia*, the human protagonist is?", answers:["Anne Boonchuy","Star Butterfly","Luz Noceda"], correct:0 },
  { id:"cartoons_095", topic:"cartoons", text:"In *Star vs. the Forces of Evil*, Star’s last name is?", answers:["Butterfly","Starling","Moon"], correct:0 },

  { id:"cartoons_096", topic:"cartoons", text:"In *Over the Garden Wall*, the two brothers are named?", answers:["Wirt and Greg","Finn and Jake","Dipper and Mabel"], correct:0 },
  { id:"cartoons_097", topic:"cartoons", text:"In *Over the Garden Wall*, the bluebird companion is?", answers:["Beatrice","Lapis","Robin"], correct:0 },
  { id:"cartoons_098", topic:"cartoons", text:"In *BoJack Horseman*, BoJack’s species is a?", answers:["Horse","Dog","Donkey"], correct:0 },
  { id:"cartoons_099", topic:"cartoons", text:"In *BoJack Horseman*, BoJack’s memoir ghostwriter is?", answers:["Diane Nguyen","Princess Carolyn","Todd Chavez"], correct:0 },
  { id:"cartoons_100", topic:"cartoons", text:"In *South Park*, the boy who often dies in early seasons is?", answers:["Kenny","Kyle","Craig"], correct:0 },

  { id:"f1_001", topic:"formula1", text:"What year did the Formula One World Championship begin?", answers:["1950","1946","1960"], correct:0 },
  { id:"f1_002", topic:"formula1", text:"Which flag indicates the race is stopped immediately?", answers:["Red flag","Black flag","Blue flag"], correct:0 },
  { id:"f1_003", topic:"formula1", text:"What does DRS stand for?", answers:["Drag Reduction System","Downforce Recovery System","Dynamic Racing Stabilizer"], correct:0 },
  { id:"f1_004", topic:"formula1", text:"What is parc fermé in F1 mainly about?", answers:["Restricted car setup/changes after qualifying","Mandatory fuel draining after the race","A tyre storage area only"], correct:0 },
  { id:"f1_005", topic:"formula1", text:"How many points are awarded for a Grand Prix win (modern system)?", answers:["25","20","10"], correct:0 },
  { id:"f1_006", topic:"formula1", text:"How many points are awarded for 10th place (modern system)?", answers:["1","2","0"], correct:0 },
  { id:"f1_007", topic:"formula1", text:"What is the minimum number of tyre compounds a driver must use in a dry race?", answers:["Two different compounds","One compound","Three different compounds"], correct:0 },
  { id:"f1_008", topic:"formula1", text:"What is the ‘107% rule’ applied to?", answers:["Qualifying participation threshold","Maximum fuel flow","Pit lane speed limit"], correct:0 },
  { id:"f1_009", topic:"formula1", text:"What is the main purpose of the Virtual Safety Car (VSC)?", answers:["Neutralize race with mandated delta without bunching the field","Stop the race and restart from the grid","Allow DRS everywhere"], correct:0 },
  { id:"f1_010", topic:"formula1", text:"Which tyre marking color typically indicates the hardest dry compound?", answers:["White","Yellow","Red"], correct:0 },

  { id:"f1_011", topic:"formula1", text:"Which circuit is traditionally the shortest by lap length among common F1 venues?", answers:["Monaco","Spa-Francorchamps","Suzuka"], correct:0 },
  { id:"f1_012", topic:"formula1", text:"Which circuit is famous for Eau Rouge/Raidillon?", answers:["Spa-Francorchamps","Monza","Interlagos"], correct:0 },
  { id:"f1_013", topic:"formula1", text:"Which circuit is known as ‘The Temple of Speed’?", answers:["Monza","Silverstone","Bahrain"], correct:0 },
  { id:"f1_014", topic:"formula1", text:"Which track features the ‘S’ curves Maggots–Becketts–Chapel?", answers:["Silverstone","Suzuka","Zandvoort"], correct:0 },
  { id:"f1_015", topic:"formula1", text:"Where is Interlagos located?", answers:["São Paulo","Rio de Janeiro","Brasília"], correct:0 },
  { id:"f1_016", topic:"formula1", text:"Which circuit is located in the Principality of Monaco?", answers:["Circuit de Monaco","Circuit Paul Ricard","Circuit de la Sarthe"], correct:0 },
  { id:"f1_017", topic:"formula1", text:"Which circuit is known for the ‘Wall of Champions’?", answers:["Circuit Gilles Villeneuve","Baku City Circuit","Singapore Street Circuit"], correct:0 },
  { id:"f1_018", topic:"formula1", text:"Which circuit uses the ‘130R’ corner name?", answers:["Suzuka","Fuji","Sepang"], correct:0 },
  { id:"f1_019", topic:"formula1", text:"Which venue is most associated with ‘The Corkscrew’ (not on modern F1 calendar)?", answers:["Laguna Seca","Watkins Glen","Road America"], correct:0 },
  { id:"f1_020", topic:"formula1", text:"Which is a street circuit known for frequent Safety Cars and walls?", answers:["Singapore","Monza","Red Bull Ring"], correct:0 },

  { id:"f1_021", topic:"formula1", text:"Which team is the only one to have competed in every F1 season since 1950?", answers:["Ferrari","McLaren","Williams"], correct:0 },
  { id:"f1_022", topic:"formula1", text:"Which constructor is nicknamed ‘The Silver Arrows’ historically?", answers:["Mercedes","Ferrari","Red Bull"], correct:0 },
  { id:"f1_023", topic:"formula1", text:"Which team won the Constructors’ Championship in 2009 with a double diffuser-era car?", answers:["Brawn GP","Renault","Toyota"], correct:0 },
  { id:"f1_024", topic:"formula1", text:"What was Renault’s team name when it won titles in 2005–2006?", answers:["Renault F1 Team","Benetton","Lotus F1 Team"], correct:0 },
  { id:"f1_025", topic:"formula1", text:"Which team introduced the ‘F-duct’ in 2010?", answers:["McLaren","Ferrari","Red Bull"], correct:0 },
  { id:"f1_026", topic:"formula1", text:"Which team is based in Maranello?", answers:["Ferrari","AlphaTauri","Sauber"], correct:0 },
  { id:"f1_027", topic:"formula1", text:"Which team is based in Woking?", answers:["McLaren","Williams","Mercedes"], correct:0 },
  { id:"f1_028", topic:"formula1", text:"Which team’s base is traditionally associated with Milton Keynes?", answers:["Red Bull Racing","Mercedes","Ferrari"], correct:0 },
  { id:"f1_029", topic:"formula1", text:"Which constructor name is strongly linked with Grove, Oxfordshire?", answers:["Williams","Lotus","Minardi"], correct:0 },
  { id:"f1_030", topic:"formula1", text:"Which team originally entered F1 as ‘Stewart Grand Prix’ (later renamed)?", answers:["Jaguar/Red Bull lineage","Benetton/Renault lineage","Jordan/Force India lineage"], correct:0 },

  { id:"f1_031", topic:"formula1", text:"How many cylinders do modern F1 internal combustion engines have?", answers:["6","8","10"], correct:0 },
  { id:"f1_032", topic:"formula1", text:"Modern F1 engines are best described as?", answers:["1.6L turbocharged V6 hybrids","2.4L naturally aspirated V8s","3.0L turbocharged V10s"], correct:0 },
  { id:"f1_033", topic:"formula1", text:"Which energy recovery unit is connected to the turbocharger shaft (classic hybrid era)?", answers:["MGU-H","MGU-K","KERS"], correct:0 },
  { id:"f1_034", topic:"formula1", text:"Which energy recovery unit is connected to the drivetrain under braking?", answers:["MGU-K","MGU-H","ERS-D"], correct:0 },
  { id:"f1_035", topic:"formula1", text:"In simple terms, downforce is aerodynamic force pushing the car?", answers:["Down onto the track","Forward along the track","Up away from the track"], correct:0 },
  { id:"f1_036", topic:"formula1", text:"Ground effect downforce primarily comes from?", answers:["Venturi tunnels/floor airflow management","Rear wing only","Tyre deformation"], correct:0 },
  { id:"f1_037", topic:"formula1", text:"What is ‘porpoising’ in F1?", answers:["Aerodynamic oscillation causing bouncing at speed","Excessive wheelspin on exits","Engine misfire under load"], correct:0 },
  { id:"f1_038", topic:"formula1", text:"What does a ‘t-bar’ (older-era terminology) relate to?", answers:["A structural mount/brace in chassis packaging","A tyre heating device","A fuel flow limiter"], correct:0 },
  { id:"f1_039", topic:"formula1", text:"The ‘halo’ is primarily a?", answers:["Driver head protection device","Fuel tank vent system","Rear wing support"], correct:0 },
  { id:"f1_040", topic:"formula1", text:"In F1, ‘monocoque’ refers to the car’s?", answers:["Single-shell safety chassis/tub","Rear suspension layout","Front wing endplate"], correct:0 },

  { id:"f1_041", topic:"formula1", text:"What does ‘undercut’ strategy usually mean?", answers:["Pitting earlier to gain time on fresh tyres","Staying out longer to save tyres","Double-stacking both cars every stop"], correct:0 },
  { id:"f1_042", topic:"formula1", text:"What does ‘overcut’ strategy usually mean?", answers:["Staying out longer to gain time/track position","Pitting early to avoid traffic","Skipping mandatory tyre changes"], correct:0 },
  { id:"f1_043", topic:"formula1", text:"What is ‘dirty air’ in F1 most associated with?", answers:["Turbulent wake that reduces following car downforce","Oil smoke from engines","Rain spray only"], correct:0 },
  { id:"f1_044", topic:"formula1", text:"What is the main tactical use of a Safety Car period for many teams?", answers:["A cheaper pit stop time-loss and position gamble","Allowing DRS activation immediately","Changing engine mapping freely"], correct:0 },
  { id:"f1_045", topic:"formula1", text:"What is ‘double-stacking’ in pit strategy?", answers:["Pitting both team cars one after the other same lap","Doing two tyre changes in one stop","Using two different fuel blends"], correct:0 },
  { id:"f1_046", topic:"formula1", text:"What does ‘box’ mean on team radio?", answers:["Pit this lap","Retire immediately","Swap positions now"], correct:0 },
  { id:"f1_047", topic:"formula1", text:"What is typically the biggest cause of tyre ‘graining’?", answers:["Rubber tearing and re-depositing due to sliding/low temps","Excessive tyre pressure always","Overheating brakes only"], correct:0 },
  { id:"f1_048", topic:"formula1", text:"What is tyre ‘blistering’ associated with?", answers:["Overheating causing bubbles under the tread surface","Low tyre wear from careful driving","Waterlogged rubber in rain"], correct:0 },
  { id:"f1_049", topic:"formula1", text:"What is the primary goal of a ‘cool-down lap’ after qualifying?", answers:["Reduce temps and return to pit safely while managing fuel/temps","Enable DRS for next lap","Trigger an automatic penalty reset"], correct:0 },
  { id:"f1_050", topic:"formula1", text:"What is slipstreaming primarily used for?", answers:["Reducing drag to increase straight-line speed","Increasing downforce in corners","Cooling tyres faster"], correct:0 },

  { id:"f1_051", topic:"formula1", text:"Which flag indicates a faster car is approaching and you should allow it to pass (in-race)?", answers:["Blue flag","Yellow flag","Green flag"], correct:0 },
  { id:"f1_052", topic:"formula1", text:"What does a single waved yellow flag mean?", answers:["Danger ahead, no overtaking, be prepared to slow","Race stopped immediately","You must pit within one lap"], correct:0 },
  { id:"f1_053", topic:"formula1", text:"What does a double waved yellow flag indicate?", answers:["Be prepared to stop; serious hazard/obstruction ahead","Track is clear and fast","DRS is enabled"], correct:0 },
  { id:"f1_054", topic:"formula1", text:"What does a green flag signal?", answers:["Track is clear / end of caution","Mandatory pit stop window open","Last lap"], correct:0 },
  { id:"f1_055", topic:"formula1", text:"What does a black-and-white diagonal flag warn a driver about?", answers:["Unsportsmanlike driving / track limits warning","Immediate disqualification","Oil on track"], correct:0 },
  { id:"f1_056", topic:"formula1", text:"What does an orange/black flag (meatball) usually mean?", answers:["Car has a dangerous mechanical problem; pit now","Driver penalty for speeding","Rain expected"], correct:0 },
  { id:"f1_057", topic:"formula1", text:"What does a black flag in F1 mean?", answers:["Disqualified; must return to pits","Drive-through penalty","Safety Car deployed"], correct:0 },
  { id:"f1_058", topic:"formula1", text:"What is the usual pit lane speed limit order of magnitude?", answers:["~80 km/h at many circuits (varies)","~200 km/h at all circuits","~30 km/h at all circuits"], correct:0 },
  { id:"f1_059", topic:"formula1", text:"What is the FIA Super Licence minimum points requirement (typical rule)?", answers:["40 points over 3 years","25 points over 2 years","60 points in 1 year"], correct:0 },
  { id:"f1_060", topic:"formula1", text:"Which is *not* a standard type of penalty?", answers:["Turbo penalty","Drive-through","Time penalty"], correct:0 },

  { id:"f1_061", topic:"formula1", text:"Which driver is famously associated with the nickname ‘The Professor’?", answers:["Alain Prost","Nigel Mansell","Kimi Räikkönen"], correct:0 },
  { id:"f1_062", topic:"formula1", text:"Which driver is strongly associated with the phrase ‘If you no longer go for a gap…’?", answers:["Ayrton Senna","Juan Manuel Fangio","Niki Lauda"], correct:0 },
  { id:"f1_063", topic:"formula1", text:"Which driver won championships with Benetton and Ferrari in the modern era?", answers:["Michael Schumacher","Sebastian Vettel","Fernando Alonso"], correct:0 },
  { id:"f1_064", topic:"formula1", text:"Which driver’s 1976 comeback from a near-fatal crash is legendary?", answers:["Niki Lauda","Gilles Villeneuve","Jochen Rindt"], correct:0 },
  { id:"f1_065", topic:"formula1", text:"Which driver is strongly linked with the number 14 in F1 history?", answers:["Fernando Alonso","Ayrton Senna","Damon Hill"], correct:0 },
  { id:"f1_066", topic:"formula1", text:"Which driver is known as ‘Iceman’?", answers:["Kimi Räikkönen","Mika Häkkinen","Valtteri Bottas"], correct:0 },
  { id:"f1_067", topic:"formula1", text:"Which driver won the 1992 title with Williams and active suspension era dominance?", answers:["Nigel Mansell","Alain Prost","Nelson Piquet"], correct:0 },
  { id:"f1_068", topic:"formula1", text:"Which driver won the 1996 title driving for Williams?", answers:["Damon Hill","Jacques Villeneuve","Mika Häkkinen"], correct:0 },
  { id:"f1_069", topic:"formula1", text:"Which driver is the first (and so far only) champion from Finland in the 2000s?", answers:["Kimi Räikkönen","Keke Rosberg","Mika Häkkinen"], correct:0 },
  { id:"f1_070", topic:"formula1", text:"Which driver is most associated with Ferrari’s first Drivers’ title in 1975?", answers:["Niki Lauda","Jody Scheckter","Emerson Fittipaldi"], correct:0 },

  { id:"f1_071", topic:"formula1", text:"What is the term for the fastest qualifying time (starting first)?", answers:["Pole position","Fastest lap","Sprint pole"], correct:0 },
  { id:"f1_072", topic:"formula1", text:"What is ‘pneumatic valve’ tech most associated with in F1 engines?", answers:["Valve return using compressed air instead of springs","Turbo spool using pressurized air","Tyre inflation during pit stops"], correct:0 },
  { id:"f1_073", topic:"formula1", text:"What does ‘ERS’ stand for in modern F1 context?", answers:["Energy Recovery System","Engine Rotation Stabilizer","Electronic Racing Suspension"], correct:0 },
  { id:"f1_074", topic:"formula1", text:"What is the primary job of the front wing endplates?", answers:["Manage airflow and vortices around front tyres","Cool the brakes directly","Hold the nose cone to the chassis"], correct:0 },
  { id:"f1_075", topic:"formula1", text:"Which is a common carbon-fibre brake material used in F1?", answers:["Carbon-carbon composite","Cast iron","Ceramic tile"], correct:0 },
  { id:"f1_076", topic:"formula1", text:"What does ‘FP1’ refer to on an F1 weekend?", answers:["Free Practice 1","First Pitstop","Final Phase 1"], correct:0 },
  { id:"f1_077", topic:"formula1", text:"What does ‘Q3’ refer to?", answers:["Final qualifying segment for top runners","Third sprint race","Third Safety Car phase"], correct:0 },
  { id:"f1_078", topic:"formula1", text:"What is the purpose of the ‘weighbridge’ procedure during sessions?", answers:["Random car weight checks for legality","Measuring driver height","Checking tyre tread depth only"], correct:0 },
  { id:"f1_079", topic:"formula1", text:"What is ‘scrutineering’?", answers:["Technical inspection for rule compliance","National anthem ceremony","Track resurfacing process"], correct:0 },
  { id:"f1_080", topic:"formula1", text:"What is a ‘formation lap’ primarily for?", answers:["Warming tyres/brakes and forming the grid order","Allowing refuelling","Opening DRS zones"], correct:0 },

  { id:"f1_081", topic:"formula1", text:"Which infamous 2008 Singapore incident is known by what nickname?", answers:["Crashgate","Spygate","Dieselgate"], correct:0 },
  { id:"f1_082", topic:"formula1", text:"What was ‘Spygate’ (2007) mainly about?", answers:["Illegally obtained technical information between teams","Fixing tyres with illegal chemicals","A manipulated start procedure"], correct:0 },
  { id:"f1_083", topic:"formula1", text:"Which safety innovation replaced refuelling-era pit lane fire risk most directly?", answers:["Ban on race refuelling (post-2009)","Mandatory wet tyres every race","Shorter races"], correct:0 },
  { id:"f1_084", topic:"formula1", text:"What does ‘blue flag’ typically apply to most strongly?", answers:["Lapped traffic being shown a faster car approaching","Start procedure failure","Mandatory tyre change"], correct:0 },
  { id:"f1_085", topic:"formula1", text:"Which is the correct order of session progression (traditional weekend)?", answers:["Practice → Qualifying → Race","Qualifying → Practice → Race","Race → Practice → Qualifying"], correct:0 },
  { id:"f1_086", topic:"formula1", text:"What is ‘push-to-pass’ called in F1 (overtake aid)?", answers:["DRS","KERS-only button","Nitro"], correct:0 },
  { id:"f1_087", topic:"formula1", text:"Which component is primarily responsible for steering input transfer?", answers:["Steering rack/column","Differential","MGU-H"], correct:0 },
  { id:"f1_088", topic:"formula1", text:"What is the ‘pit wall’ in F1 terms?", answers:["Team’s trackside operations/strategy stand","The concrete barrier at pit entry","A mandatory safety structure inside the garage"], correct:0 },
  { id:"f1_089", topic:"formula1", text:"What does ‘lift and coast’ mean?", answers:["Lifting off throttle early and coasting to save fuel/temps","Accelerating later to save tyres","Braking later to save pads"], correct:0 },
  { id:"f1_090", topic:"formula1", text:"What is the main purpose of ‘engine modes’/maps (within rules)?", answers:["Adjust power deployment and efficiency/temps","Change tyre compound hardness","Increase DRS angle beyond limits"], correct:0 },

  { id:"f1_091", topic:"formula1", text:"Which circuit is famous for ‘The Senna S’ (first corner complex)?", answers:["Interlagos","Imola","Suzuka"], correct:0 },
  { id:"f1_092", topic:"formula1", text:"Which circuit includes the ‘Piscine’ section?", answers:["Monaco","Barcelona","Hungaroring"], correct:0 },
  { id:"f1_093", topic:"formula1", text:"Which circuit is known for ‘The Esses’ and ‘Degner’ corners?", answers:["Suzuka","Silverstone","COTA"], correct:0 },
  { id:"f1_094", topic:"formula1", text:"Which circuit’s layout historically included ‘Hockenheim forest’ long straights?", answers:["Hockenheimring","Nürburgring GP","Zolder"], correct:0 },
  { id:"f1_095", topic:"formula1", text:"Which circuit is commonly associated with ‘The Hungaroring’ being hard to overtake on?", answers:["Budapest venue (Hungaroring)","Monza","Spa"], correct:0 },
  { id:"f1_096", topic:"formula1", text:"Which circuit is commonly known as ‘COTA’?", answers:["Circuit of the Americas","Circuit de Catalunya","Circuit of Australia"], correct:0 },
  { id:"f1_097", topic:"formula1", text:"Which circuit is in the Netherlands known for steep banking in modern F1?", answers:["Zandvoort","Assen","Zolder"], correct:0 },
  { id:"f1_098", topic:"formula1", text:"Which race is most associated with the ‘Triple Crown’ leg in Monaco?", answers:["Monaco Grand Prix","Italian Grand Prix","British Grand Prix"], correct:0 },
  { id:"f1_099", topic:"formula1", text:"What does ‘DNF’ stand for on timing screens?", answers:["Did Not Finish","Driver Not Found","Downforce Not Functioning"], correct:0 },
  { id:"f1_100", topic:"formula1", text:"What does ‘DNS’ stand for on timing screens?", answers:["Did Not Start","Driver Needs Service","Downshift Not Smooth"], correct:0 },

{ id:"olym_001", topic:"olympics", text:"First modern Olympic Games (1896) host city?", answers:["Athens","Paris","London"], correct:0 },
{ id:"olym_002", topic:"olympics", text:"IOC founded in which year?", answers:["1894","1886","1900"], correct:0 },
{ id:"olym_003", topic:"olympics", text:"Founder most associated with modern Olympics?", answers:["Pierre de Coubertin","Avery Brundage","Juan Antonio Samaranch"], correct:0 },
{ id:"olym_004", topic:"olympics", text:"Olympic motto begins with which Latin word?", answers:["Citius","Gloria","Virtus"], correct:0 },
{ id:"olym_005", topic:"olympics", text:"The Olympic rings first appeared at which Games?", answers:["1920 Antwerp","1896 Athens","1908 London"], correct:0 },
{ id:"olym_006", topic:"olympics", text:"How many rings are on the Olympic symbol?", answers:["5","4","6"], correct:0 },
{ id:"olym_007", topic:"olympics", text:"Olympic flame/torch relay introduced at which Games?", answers:["1936 Berlin","1924 Paris","1948 London"], correct:0 },
{ id:"olym_008", topic:"olympics", text:"First Winter Olympics host (1924)?", answers:["Chamonix","St. Moritz","Oslo"], correct:0 },
{ id:"olym_009", topic:"olympics", text:"Which Games were cancelled due to World War I?", answers:["1916","1912","1920"], correct:0 },
{ id:"olym_010", topic:"olympics", text:"Which Games were cancelled due to World War II (first)?", answers:["1940","1936","1948"], correct:0 },

{ id:"olym_011", topic:"olympics", text:"Which Games were cancelled due to World War II (second)?", answers:["1944","1940","1952"], correct:0 },
{ id:"olym_012", topic:"olympics", text:"Marathon distance standardized to 42.195 km after which Games?", answers:["1908 London","1896 Athens","1924 Paris"], correct:0 },
{ id:"olym_013", topic:"olympics", text:"First Olympics held in the United States?", answers:["1904 St. Louis","1932 Los Angeles","1984 Los Angeles"], correct:0 },
{ id:"olym_014", topic:"olympics", text:"First Olympics held in Asia (Summer)?", answers:["1964 Tokyo","1952 Helsinki","1972 Munich"], correct:0 },
{ id:"olym_015", topic:"olympics", text:"Only city to host the Summer Olympics three times?", answers:["London","Paris","Los Angeles"], correct:0 },
{ id:"olym_016", topic:"olympics", text:"Country that has participated in every modern Summer Olympics?", answers:["Greece","USA","France"], correct:0 },
{ id:"olym_017", topic:"olympics", text:"First year women competed in the modern Olympics?", answers:["1900","1896","1912"], correct:0 },
{ id:"olym_018", topic:"olympics", text:"Olympic anthem composer?", answers:["Spyridon Samaras","Giuseppe Verdi","Jean Sibelius"], correct:0 },
{ id:"olym_019", topic:"olympics", text:"Olympic anthem lyrics written by?", answers:["Kostis Palamas","Homer","Sappho"], correct:0 },
{ id:"olym_020", topic:"olympics", text:"Olympic oath first used at which Games?", answers:["1920 Antwerp","1900 Paris","1936 Berlin"], correct:0 },

{ id:"olym_021", topic:"olympics", text:"Which sport is NOT in the modern pentathlon?", answers:["Cycling","Fencing","Swimming"], correct:0 },
{ id:"olym_022", topic:"olympics", text:"Modern pentathlon includes which equestrian discipline (traditional format)?", answers:["Show jumping","Dressage","Cross-country"], correct:0 },
{ id:"olym_023", topic:"olympics", text:"Decathlon includes which long run?", answers:["1500 m","5000 m","800 m"], correct:0 },
{ id:"olym_024", topic:"olympics", text:"Heptathlon includes which final event?", answers:["800 m","1500 m","400 m"], correct:0 },
{ id:"olym_025", topic:"olympics", text:"Sport that debuted at 1998 Winter Olympics?", answers:["Snowboarding","Biathlon","Bobsleigh"], correct:0 },
{ id:"olym_026", topic:"olympics", text:"Beach volleyball first became an Olympic sport in?", answers:["1996","1992","2000"], correct:0 },
{ id:"olym_027", topic:"olympics", text:"Triathlon debuted at which Summer Olympics?", answers:["2000 Sydney","1996 Atlanta","2004 Athens"], correct:0 },
{ id:"olym_028", topic:"olympics", text:"Which is an Olympic rowing boat class (historically common)?", answers:["Coxless four","Dragon boat","Outrigger canoe"], correct:0 },
{ id:"olym_029", topic:"olympics", text:"FIE governs Olympic which sport?", answers:["Fencing","Archery","Judo"], correct:0 },
{ id:"olym_030", topic:"olympics", text:"Which is NOT a track cycling discipline category?", answers:["Downhill","Sprint","Keirin"], correct:0 },

{ id:"olym_031", topic:"olympics", text:"Which sport uses a piste?", answers:["Fencing","Badminton","Canoe slalom"], correct:0 },
{ id:"olym_032", topic:"olympics", text:"In Olympic boxing, what does RSC historically indicate?", answers:["Referee stops contest","Ring side coach","Round score count"], correct:0 },
{ id:"olym_033", topic:"olympics", text:"Which country won the first modern Olympic marathon (1896) athlete nationality?", answers:["Greek","French","American"], correct:0 },
{ id:"olym_034", topic:"olympics", text:"Ancient Olympics were held at Olympia in honor of?", answers:["Zeus","Apollo","Ares"], correct:0 },
{ id:"olym_035", topic:"olympics", text:"Olympic rings are commonly said to represent?", answers:["The union of continents","Five oceans","Five athletic virtues"], correct:0 },
{ id:"olym_036", topic:"olympics", text:"Which is NOT one of the ring colors?", answers:["Purple","Green","Black"], correct:0 },
{ id:"olym_037", topic:"olympics", text:"Olympic flag background color?", answers:["White","Blue","Gold"], correct:0 },
{ id:"olym_038", topic:"olympics", text:"Traditional Olympic opening includes athletes marching by?", answers:["Nation","Sport","Alphabetical by surname"], correct:0 },
{ id:"olym_039", topic:"olympics", text:"Which nation traditionally enters first in opening parade?", answers:["Greece","Host nation","France"], correct:0 },
{ id:"olym_040", topic:"olympics", text:"Which nation traditionally enters last in opening parade?", answers:["Host nation","Greece","IOC Refugee Team"], correct:0 },

{ id:"olym_041", topic:"olympics", text:"Most Olympic gold medals (all sports) athlete?", answers:["Michael Phelps","Usain Bolt","Paavo Nurmi"], correct:0 },
{ id:"olym_042", topic:"olympics", text:"Most total Olympic medals (all sports) athlete?", answers:["Michael Phelps","Larisa Latynina","Mark Spitz"], correct:0 },
{ id:"olym_043", topic:"olympics", text:"Soviet gymnast with 18 Olympic medals (classic trivia)?", answers:["Larisa Latynina","Nadia Comăneci","Svetlana Khorkina"], correct:0 },
{ id:"olym_044", topic:"olympics", text:"Only athlete to win Olympic gold in Summer and Winter (classic trivia)?", answers:["Eddie Eagan","Eric Heiden","Clara Hughes"], correct:0 },
{ id:"olym_045", topic:"olympics", text:"Jesse Owens won four gold medals at which Olympics?", answers:["1936 Berlin","1928 Amsterdam","1948 London"], correct:0 },
{ id:"olym_046", topic:"olympics", text:"Nadia Comăneci’s first perfect 10 was at which Olympics?", answers:["1976 Montreal","1972 Munich","1980 Moscow"], correct:0 },
{ id:"olym_047", topic:"olympics", text:"Usain Bolt’s signature triple (100/200/4x100) first achieved at?", answers:["2008 Beijing","2004 Athens","2016 Rio"], correct:0 },
{ id:"olym_048", topic:"olympics", text:"Paavo Nurmi is most associated with which sport?", answers:["Athletics (distance)","Wrestling","Rowing"], correct:0 },
{ id:"olym_049", topic:"olympics", text:"First Olympic Games to feature a mascot (widely cited) were?", answers:["1972 Munich","1968 Mexico City","1980 Moscow"], correct:0 },
{ id:"olym_050", topic:"olympics", text:"“Miracle on Ice” happened at which Winter Olympics?", answers:["1980 Lake Placid","1976 Innsbruck","1984 Sarajevo"], correct:0 },

{ id:"olym_051", topic:"olympics", text:"In Olympic swimming, what stroke order is used in medley relay?", answers:["Back-Breast-Fly-Free","Fly-Back-Breast-Free","Breast-Back-Free-Fly"], correct:0 },
{ id:"olym_052", topic:"olympics", text:"In the decathlon, which event is NOT included?", answers:["800 m","Pole vault","Discus"], correct:0 },
{ id:"olym_053", topic:"olympics", text:"In judo, an ippon signifies?", answers:["Instant win","Penalty only","Tie-break score"], correct:0 },
{ id:"olym_054", topic:"olympics", text:"In Olympic taekwondo, the contest area is called the?", answers:["Octagon","Dojo","Mat circle"], correct:0 },
{ id:"olym_055", topic:"olympics", text:"In fencing, right-of-way applies to which weapons?", answers:["Foil and sabre","Épée only","All three equally"], correct:0 },
{ id:"olym_056", topic:"olympics", text:"Olympic shooting: ISSF stands for?", answers:["International Shooting Sport Federation","International Sport Safety Federation","International Smallbore & Shot Federation"], correct:0 },
{ id:"olym_057", topic:"olympics", text:"Canoe slalom is competed on?", answers:["Whitewater course","Stillwater lake","Open ocean"], correct:0 },
{ id:"olym_058", topic:"olympics", text:"In modern Olympic archery, the standard target face has how many colored rings?", answers:["10 scoring rings","5 scoring rings","12 scoring rings"], correct:0 },
{ id:"olym_059", topic:"olympics", text:"In Olympic badminton, the shuttle is also called?", answers:["Shuttlecock","Birdie ball","Feather dart"], correct:0 },
{ id:"olym_060", topic:"olympics", text:"Handball team size on court (indoor) per side?", answers:["7","6","5"], correct:0 },

{ id:"olym_061", topic:"olympics", text:"In volleyball, a team is allowed how many touches before returning the ball?", answers:["3","2","4"], correct:0 },
{ id:"olym_062", topic:"olympics", text:"In water polo, a team fields how many players in the pool?", answers:["7","6","8"], correct:0 },
{ id:"olym_063", topic:"olympics", text:"In Olympic football (soccer), men’s tournament is mainly?", answers:["U-23 with limited overage","Open age like FIFA World Cup","U-19 only"], correct:0 },
{ id:"olym_064", topic:"olympics", text:"In rugby sevens, a match half is typically?", answers:["7 minutes","10 minutes","15 minutes"], correct:0 },
{ id:"olym_065", topic:"olympics", text:"In basketball, FIBA games are how many minutes total?", answers:["40","48","36"], correct:0 },
{ id:"olym_066", topic:"olympics", text:"In Olympic baseball/softball, a “mercy rule” refers to?", answers:["Ending game at large lead","Extra innings","Free base on error"], correct:0 },
{ id:"olym_067", topic:"olympics", text:"In equestrian, “dressage” is best described as?", answers:["Horse training test of movements","Jumping over fences only","Cross-country endurance"], correct:0 },
{ id:"olym_068", topic:"olympics", text:"Which is a Winter Olympic sliding sport?", answers:["Skeleton","Nordic combined","Ski jumping"], correct:0 },
{ id:"olym_069", topic:"olympics", text:"Biathlon combines cross-country skiing with?", answers:["Rifle shooting","Archery","Pistol dueling"], correct:0 },
{ id:"olym_070", topic:"olympics", text:"Curling teams typically have how many players?", answers:["4","5","3"], correct:0 },

{ id:"olym_071", topic:"olympics", text:"Figure skating: a “toe loop” is a type of?", answers:["Jump","Spin","Step sequence"], correct:0 },
{ id:"olym_072", topic:"olympics", text:"Alpine skiing: slalom vs giant slalom differs mainly in?", answers:["Gate spacing and turn radius","Skis must be longer","Only slalom uses poles"], correct:0 },
{ id:"olym_073", topic:"olympics", text:"In speed skating, races are on an oval of?", answers:["400 m track","200 m track","500 m track"], correct:0 },
{ id:"olym_074", topic:"olympics", text:"In short track, overtaking rules are known to be?", answers:["More contact-prone/tactical","No passing allowed","Only inside passes count"], correct:0 },
{ id:"olym_075", topic:"olympics", text:"Nordic combined includes cross-country skiing plus?", answers:["Ski jumping","Alpine downhill","Freestyle moguls"], correct:0 },
{ id:"olym_076", topic:"olympics", text:"Ski jumping hill size is often labeled as?", answers:["K-point/HS","MPH-index","Slope grade"], correct:0 },
{ id:"olym_077", topic:"olympics", text:"Freestyle skiing “moguls” course features?", answers:["Bumps and jumps","Gates like slalom","Halfpipe walls"], correct:0 },
{ id:"olym_078", topic:"olympics", text:"Snowboard “halfpipe” is a?", answers:["U-shaped ramp","Downhill gate course","Flat rail park"], correct:0 },
{ id:"olym_079", topic:"olympics", text:"Cross-country skiing sprint format often uses?", answers:["Heats to final","Single time trial only","Best-of-3 races"], correct:0 },
{ id:"olym_080", topic:"olympics", text:"Ice hockey period length (international) is?", answers:["20 minutes","15 minutes","25 minutes"], correct:0 },

{ id:"olym_081", topic:"olympics", text:"2028 Summer Olympics host city?", answers:["Los Angeles","Paris","Brisbane"], correct:0 },
{ id:"olym_082", topic:"olympics", text:"2032 Summer Olympics host city?", answers:["Brisbane","Rome","Berlin"], correct:0 },
{ id:"olym_083", topic:"olympics", text:"2026 Winter Olympics are hosted in Italy by?", answers:["Milano-Cortina","Turin-Genoa","Rome-Naples"], correct:0 },
{ id:"olym_084", topic:"olympics", text:"Olympic motto was officially updated by adding which word?", answers:["Together","Forever","Unity"], correct:0 },
{ id:"olym_085", topic:"olympics", text:"The motto “Citius, Altius, Fortius” means?", answers:["Faster, Higher, Stronger","Stronger, Braver, Bolder","Swifter, Safer, Smarter"], correct:0 },
{ id:"olym_086", topic:"olympics", text:"The Olympic Movement’s top governing body is the?", answers:["IOC","FIFA","WADA"], correct:0 },
{ id:"olym_087", topic:"olympics", text:"A nation’s Olympic body is called a?", answers:["NOC","NPC","NWC"], correct:0 },
{ id:"olym_088", topic:"olympics", text:"Olympic “A” standard/qualification generally refers to?", answers:["Eligibility entry requirement","Gold medal score","Host city selection"], correct:0 },
{ id:"olym_089", topic:"olympics", text:"“Olympiad” technically denotes a period of?", answers:["Four years","One year","Two years"], correct:0 },
{ id:"olym_090", topic:"olympics", text:"The Summer Olympics are officially numbered by?", answers:["Olympiad","Calendar year","Host city order"], correct:0 },

{ id:"olym_091", topic:"olympics", text:"Which city hosted the 1968 Summer Olympics (high altitude)?", answers:["Mexico City","Madrid","Lima"], correct:0 },
{ id:"olym_092", topic:"olympics", text:"Which city hosted the 1972 Summer Olympics?", answers:["Munich","Montreal","Moscow"], correct:0 },
{ id:"olym_093", topic:"olympics", text:"Which city hosted the 1988 Summer Olympics?", answers:["Seoul","Barcelona","Atlanta"], correct:0 },
{ id:"olym_094", topic:"olympics", text:"Which city hosted the 1992 Summer Olympics?", answers:["Barcelona","Sydney","Athens"], correct:0 },
{ id:"olym_095", topic:"olympics", text:"Which city hosted the 2004 Summer Olympics?", answers:["Athens","Beijing","London"], correct:0 },
{ id:"olym_096", topic:"olympics", text:"Which city hosted the 2016 Summer Olympics?", answers:["Rio de Janeiro","Tokyo","Beijing"], correct:0 },
{ id:"olym_097", topic:"olympics", text:"Winter host city for 1994 Olympics?", answers:["Lillehammer","Nagano","Salt Lake City"], correct:0 },
{ id:"olym_098", topic:"olympics", text:"Winter host city for 2010 Olympics?", answers:["Vancouver","Turin","Sochi"], correct:0 },
{ id:"olym_099", topic:"olympics", text:"Which Winter Olympics were held in Japan in 1998?", answers:["Nagano","Sapporo","Tokyo"], correct:0 },
{ id:"olym_100", topic:"olympics", text:"Which Winter Olympics were held in China in 2022?", answers:["Beijing","Harbin","Shanghai"], correct:0 }
