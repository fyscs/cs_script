...
/**
 * 防化脚本
 * 此脚本为针对类似zed社区会锁定僵尸血量防止超过血量上限而提供的特供脚本
 * 此脚本由皮皮猫233编写
 * 2026/2/27
 */
...
// @ts-ignore
Instance.OnBeforePlayerDamage((event) => currentHandler(event));
...
function createDamageHandler(enabled) {
    ...
    return (/** @type {import("cs_script/point_script").BeforePlayerDamageEvent} */ event) => {
