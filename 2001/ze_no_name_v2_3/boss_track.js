...
const boss_hp_add = 450;//boss动态血量,乘以人数后累加至血量中
...
const boss_end_relay = "st3_boss_relay";//boss死亡后自动触发的relay,可自行配置targetname,修改的同时需要将地图中的relay名称同步更改
const boss_end_relay_boolean = true;//boss是否启用死亡后的relay输出
const boss_end_relay_delay = 0;//boss是否启用死亡后的relay输出延迟
const boss_track_traget_boolean = false;//boss锁定目标显示开关,若不需要改为false
