...
let b_ScriptEnt_name = "boss1_script";

let b_PhysBox = null;
let b_PhysBox_name = "boss1_break";

let b_BossTrain = null;
let b_BossTrain_name = "boss1_CY01Physic"; 

let b_Fpath = null;
let b_Fp_name = "boss1_first_path";

let b_Spath = null;
let b_Sp_name = "boss1_sec_path";

let b_Model = null;
let b_Model_name = "boss1";
...
Instance.OnScriptInput("StartMove", () => {
    ...
    let tm_ang = GetYawFVect2D(gto, npc_m_gto) - 90;
