...
const InPuts = [
    ["boss_spider_start", "OnTrigger", "boss_break_head,script_boss_hp,boss_hud,Spider,100,10", StartBoss],
    ["boss_spider_start", "OnTrigger", "0,200", AddHealth],
    ["boss_nazgul_start", "OnTrigger", "box_nazgryl,script_boss_hp,boss_hud,Nazgul,50,10", StartBoss],
    ["boss_nazgul_start", "OnTrigger", "0,30", AddHealth],
    ["boss_urukhai_start", "OnTrigger", "boss1_break,script_boss_hp,boss_hud,Urukhai,50,10", StartBoss],
    ["boss_urukhai_start", "OnTrigger", "0,150", AddHealth],
    ["boss_grima_start", "OnTrigger", "box_grima_helth,script_boss_hp,boss_hud,Grima,50,10", StartBoss],
    ["boss_grima_start", "OnTrigger", "0,12", AddHealth],
    ["boss_saruman_start", "OnTrigger", "boss3_break,script_boss_hp,boss_hud,Saruman,50,10", StartBoss],
    ["boss_saruman_start", "OnTrigger", "0,150", AddHealth],
];
