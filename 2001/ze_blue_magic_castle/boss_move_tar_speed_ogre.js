...
const TICKRATE = 0.1;
const TURN_STEP_TIME = 0.01;
const TARGET_DISTANCE = 15000;
const SPEED_FORWARD = 220;
const RETARGET_TIME = 8;

const boss_model = "speed_ogre_model";
const boss_move_physbox = "speed_ogre_move";
const boss_script_ent = "sp_ogre_script";
...
function SetGraduallyAng(ang_t, ent)
{
    ...
    let add_gs = speed_turning * TURN_STEP_TIME;
    while (ang_y < -180) 
    {
        ang_y = ang_y + 360;
    }
