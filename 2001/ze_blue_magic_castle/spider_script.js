...
const npc_name = "npc_spider_small_phys_break*";
const NPC_MAKER = "template_npc_spider_small";
const boss_script = "spider_npc_script";
let NPC_ENT = null;
let NPC_ENTS_ASPAWN = null;
let IGNORE_BOSS = [];

const BOSS_ENTITIES_MAP = {
    "npc_spider_small_phys_break": "SetBossPhysBoxEnt",
    "Spider_move": "SetBossTrainEnt",
    "Spider_move_track": "SetBossFirstPathEnt",
    "Spider_move_track1": "SetBossSecPathEnt",
    "npc_spider_small_model": "SetBossModelEnt",
};
