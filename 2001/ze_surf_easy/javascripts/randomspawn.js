...
const CONFIG = {
  ...
  // 模板列表
  TEMPLATES: ['rain_laser_tmpl_01', 'rain_laser_tmpl_02', 'rain_laser_tmpl_03'],
...
function SpawnLaser(templateName) {
  ...
  // ============================================================
  const rx =
    Math.random() * (CONFIG.RANGE_X_MAX - CONFIG.RANGE_X_MIN) +
    CONFIG.RANGE_X_MIN
  const ry =
    Math.random() * (CONFIG.RANGE_Y_MAX - CONFIG.RANGE_Y_MIN) +
    CONFIG.RANGE_Y_MIN
  const rz =
    Math.random() * (CONFIG.RANGE_Z_MAX - CONFIG.RANGE_Z_MIN) +
    CONFIG.RANGE_Z_MIN
